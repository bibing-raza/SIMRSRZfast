...
public class DlgFrekuensiPenyakitRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        NmRuangan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "SEMUA RUANG", "ZAAL", "RKPD", "PARU", "JANTUNG", "AS-SAMI", "AS-SAMI/UMUM", "ANAK", "BEDAH", "INTERNIST", "ICU/ICCU", "NICU", "OBGYN", "VIP", "SVIP", "BAYI-SEHAT", "AR-RAUDAH", "SYARAF", "MATA-THT-KK", "ISOLASI COVID19", "ISOLASI BAYI COVID19", "COVID19" }));
        ...
        cmbRuangKhusus1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AS-SAMI", "JANTUNG", "AS-SAMI/UMUM" }));
        ...
        cmbRuangKhusus2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "INTERNIST", "ZAAL", "RKPD" }));
        ...
        cmbRuangKhusus3.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "NICU", "BAYI-SEHAT" }));
        ...
        cmbRuangKhusus4.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "AR-RAUDAH", "SYARAF", "MATA-THT-KK" }));
        ...
        cmbRuangKhusus5.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "VIP", "SVIP", "ISOLASI COVID19", "ISOLASI BAYI COVID19", "COVID19" }));
...
private void ppGrafikTerkecilPieActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppGrafikTerkecilPieActionPerformed
    ...
    private void ppDaftarTerbanyakPerRuanganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppDaftarTerbanyakPerRuanganActionPerformed
        if (ruangDicetak.getText().equals("")) {
            ...
            if (ruangDicetak.getText().equals("AR-RAZAQ") || (ruangDicetak.getText().equals("ZAAL"))) {
                ctkRuangRKPDzaalTglKeluar();
            } else if (ruangDicetak.getText().equals("AS-SAMI/GENERAL")) {
                ctkPerRuanganTglKeluar();
            } else if (ruangDicetak.getText().equals("SEMUA RUANG")) {
    ...
    private void NmRuanganMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_NmRuanganMouseClicked
        ...
        if (!NmRuangan.getSelectedItem().equals("")) {
            if (NmRuangan.getSelectedItem().equals("RKPD")) {
                ruangDicetak.setText("AR-RAZAQ");
            } else if (NmRuangan.getSelectedItem().equals("ZAAL")) {
                ruangDicetak.setText("ZAAL");
            } else if (NmRuangan.getSelectedItem().equals("AS-SAMI/UMUM")) {
    ...
    private void ppRincianPerDiagnosaTglMskActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppRincianPerDiagnosaTglMskActionPerformed
        if (ruangDicetak.getText().equals("")) {
            ...
            } else if (ruangDicetak.getText().equals("AS-SAMI/GENERAL") || (!ruangDicetak.getText().equals("SEMUA RUANG"))) {
                prinRincianDiagnosaTglMasuk();
            } else if (ruangDicetak.getText().equals("SEMUA RUANG")) {
    ...
    private void cmbRuangKhusus5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cmbRuangKhusus5MouseClicked
        judulRuangan.setText(cmbRuangKhusus5.getSelectedItem().toString());
    ...
    */
    ...
    public void UserValid() {
        b = Sequel.cariIsi("SELECT nip FROM hak_akses_unit WHERE nip='" + akses.getkode() + "' ");
        userBerizin.setText(b);
        ...
        if (userBerizin.getText().equals("")) {
            ...
            if (userBerizin.getText().equals("PR04")) {
                ...
                a = Sequel.cariIsi("SELECT kode_unit FROM hak_akses_unit WHERE nip='" + akses.getkode() + "' ");
                kdAkses.setText(a);

                if (kdAkses.getText().equals("")) {
                    NmRuangan.setSelectedIndex(0);
                } else if (!kdAkses.getText().equals("")) {
                    NmRuangan.setSelectedItem(a);
                }
                prosesCari();
            }
        }
    ...
    public void prinRincianDiagnosaTglMasuk() {
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        Map<String, Object> param = new HashMap<>();
        param.put("namars", akses.getnamars());
        param.put("alamatrs", akses.getalamatrs());
