...
private void BtnCariKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnCariKeyPressed
    ...
    */
    ...
    public void UserValid() {
        ...
        } else if ((userBerizin.equals("Admin Utama")) || (userBerizin.equals("PPRM"))) {
        ...
        } else if ((!userBerizin.equals(""))
                || ((!userBerizin.equals("Admin Utama"))
                || (!userBerizin.equals("PPRM")))) {
            BtnUnit.setEnabled(false);
            BtnCari.setEnabled(true);
            BtnAll.setEnabled(false);
            cekSemuaPoli.setSelected(false);
