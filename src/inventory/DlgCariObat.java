...
public final class DlgCariObat extends javax.swing.JDialog {
    ...
    private int i = 0, z = 0, cekCat = 0, a = 0, cekResep = 0;
...
//            }
            public boolean isCellEditable(int rowIndex, int colIndex) {
                boolean a = true;
                if ((colIndex == 2) || (colIndex == 3) || (colIndex == 4) || (colIndex == 5) || (colIndex == 6)|| (colIndex == 7)|| (colIndex == 8)) {
                    a = false;
                }
                return a;
            }
...
//                    column.setPreferredWidth(1);
    ...
    private void initComponents() {
        ...
        ppCatatanResep = new javax.swing.JMenuItem();
        ...
        ppCatatanResep.setBackground(new java.awt.Color(255, 255, 255));
        ppCatatanResep.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        ppCatatanResep.setForeground(new java.awt.Color(0, 0, 0));
        ppCatatanResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        ppCatatanResep.setActionCommand("Catatan Resep");
        ppCatatanResep.setHorizontalAlignment(javax.swing.SwingConstants.LEFT);
        ppCatatanResep.setHorizontalTextPosition(javax.swing.SwingConstants.RIGHT);
        ppCatatanResep.setIconTextGap(8);
        ppCatatanResep.setLabel("Catatan Resep");
        ppCatatanResep.setName("ppCatatanResep"); // NOI18N
        ppCatatanResep.setPreferredSize(new java.awt.Dimension(200, 25));
        ppCatatanResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                ppCatatanResepActionPerformed(evt);
            }
        });
        Popup.add(ppCatatanResep);
        ...
        MnCetakResepDokter.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-11-2022" }));
        ...
        jLabel3.setText("Catatan Resep Obat Dokter :");
        jLabel3.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        jLabel3.setName("jLabel3"); // NOI18N
        FormInput.add(jLabel3);
        jLabel3.setBounds(10, 84, 190, 23);
        ...
        BtnUpdate.setText("Update Resep Obat");
        ...
        BtnUpdate.setBounds(356, 83, 158, 23);

        BtnCekResep.setForeground(new java.awt.Color(0, 0, 0));
        BtnCekResep.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/accept_page.png"))); // NOI18N
        BtnCekResep.setMnemonic('C');
        BtnCekResep.setText("Cek Resep");
        BtnCekResep.setToolTipText("Alt+C");
        BtnCekResep.setName("BtnCekResep"); // NOI18N
        BtnCekResep.setPreferredSize(new java.awt.Dimension(28, 23));
        BtnCekResep.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                BtnCekResepActionPerformed(evt);
            }
        });
        FormInput.add(BtnCekResep);
        BtnCekResep.setBounds(520, 83, 110, 23);
        ...
        FormInput.add(chkResepObat);
        chkResepObat.setBounds(245, 83, 100, 23);
...
//                                        * (Double.parseDouble(tbObat.getValueAt(i, 1).toString()) / carikapasitas.getDouble(1)))), "Ralan", bangsal
                                        if (Sequel.menyimpantf2("detail_pemberian_obat", "?,?,?,?,?,?,?,?,?,?,?,?,?", "data", 14, new String[]{
                                            ...
                                            + Double.parseDouble(tbObat.getValueAt(i, 9).toString()) + (Double.parseDouble(tbObat.getValueAt(i, 6).toString())
                                            * (Double.parseDouble(tbObat.getValueAt(i, 1).toString()) / carikapasitas.getDouble(1)))), "Ralan", bangsal, "Belum", "-"
                                        }) == true) {
                                            isRawat();
...
//                                        tbObat.getValueAt(i, 8).toString(), tbObat.getValueAt(i, 9).toString(), "" + (Double.parseDouble(tbObat.getValueAt(i, 8).toString())
//                                        + Double.parseDouble(tbObat.getValueAt(i, 9).toString()) + (Double.parseDouble(tbObat.getValueAt(i, 6).toString())
//                                        * Double.parseDouble(tbObat.getValueAt(i, 1).toString()))), "Ralan", bangsal
                                        if (Sequel.menyimpantf("detail_pemberian_obat", "?,?,?,?,?,?,?,?,?,?,?,?,?,?", "data", 14, new String[]{
                                            ...
                                            * Double.parseDouble(tbObat.getValueAt(i, 1).toString()))), "Ralan", bangsal, "Belum", "-"
                                        }) == true) {
                                            isRawat();
                                            Sequel.menyimpan("aturan_pakai", "?,?,?,?,?,?,?,?,?,?,?", 11, new String[]{
                                                ...
                                                tbObat.getValueAt(i, 12).toString(), tbObat.getValueAt(i, 13).toString(), tbObat.getValueAt(i, 14).toString(), tbObat.getValueAt(i, 15).toString()
                                            });
...
private void JeniskelasKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_JeniskelasKeyPressed
    ...
    private void ppCatatanResepActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ppCatatanResepActionPerformed
        dlgCatatanResep.setNoRw(TNoRw.getText());
        dlgCatatanResep.isCek();
        dlgCatatanResep.setSize(720, 330);
        dlgCatatanResep.setLocationRelativeTo(internalFrame1);
        dlgCatatanResep.setVisible(true);

    }//GEN-LAST:event_ppCatatanResepActionPerformed
...
//                obat = tbResepObat.getValueAt(i, 2).toString();
//                
//                for (a = 0; a< obat.length(); a++){
//                    if(Character.toString(obat.charAt(0)).equals("\\")){
//                        
//                    }else{
//                        
//                    }
...
//                Sequel.queryu("update catatan_resep set status = '" + stat + "' where no_rawat='" + tbResepObat.getValueAt(i, 1).toString() + "' and replace(nama_obat,'\\\\','')='" + tbResepObat.getValueAt(i, 2).toString().replace("\\", "") + "'");
                Sequel.queryu("update catatan_resep set status = '" + stat + "' where no_rawat='" + tbResepObat.getValueAt(i, 1).toString() + "' and noId='" + tbResepObat.getValueAt(i, 4).toString() + "'");
            }
    ...
    private javax.swing.JMenuItem ppCatatanResep;
