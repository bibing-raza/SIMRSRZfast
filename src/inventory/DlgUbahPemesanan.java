...
public class DlgUbahPemesanan extends javax.swing.JDialog {
    ...
    private double saldoawal = 0, mutasi = 0, ttl = 0, y = 0, w = 0, ttldisk = 0, sbttl = 0, ppn = 0, tagihan = 0, jmlkonversi = 0, hargappn = 0, ppnPctg = 0, stokbarang2 = 0;
    ...
    public DlgUbahPemesanan(java.awt.Frame parent, boolean modal) {
        ...
        suplier.addWindowListener(new WindowListener() {
            ...
            @Override
            public void windowClosed(WindowEvent e) {
                if (akses.getform().equals("DlgUbahPemesanan")) {
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ubah Pemesanan Obat, Alkes & BHP Medis ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        LSubtotal.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LPotongan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LTotal2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        LTagiha.setForeground(new java.awt.Color(0, 0, 0));
        ...
        tppn.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglPesan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglTempo.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglFaktur.setForeground(new java.awt.Color(0, 0, 0));
        ...
        NoOrder.setForeground(new java.awt.Color(0, 0, 0));
        ...
        chkFree.setBounds(770, 10, 74, 16);
...
*/
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NoFaktur.getText().trim().equals("")) {
            ...
            TCari.requestFocus();
        } else if (chkFree.isSelected() == false && ttl <= 0) {
...
//                if (var.getnamauser().equals("Admin Utama")) {
                ...
                try { 
                    cek = 0;
                    pscaripesan.setString(1, fakturNo);
                    ...
                    if (rs.next()) {
                        ...
                        if (cek > 0) {
                            ...
                            rs2 = psdetailpesan.executeQuery();
                            while (rs2.next()) {
                                Trackobat.catatRiwayat2(rs2.getString("kode_brng"), 0, rs2.getDouble("jumlah2"), "Ubah Pemesanan", akses.getkode(), rs.getString("kd_bangsal"), "Hapus");
                            ...
                            Sequel.queryu2("delete from pemesanan where no_faktur=?", 1, new String[]{fakturNo});
                                    ...
                                    try {
                                        if (Valid.SetAngka(tbDokter.getValueAt(i, 0).toString()) > 0) {
                                            if (Sequel.menyimpantf2("detailpesan", "?,?,?,?,?,?,?,?,?,?,?", "Transaksi Pemesanan", 11, new String[]{
                                                ...
                                                Trackobat.catatRiwayat2(tbDokter.getValueAt(i, 2).toString(), Valid.SetAngka(tbDokter.getValueAt(i, 12).toString()), 0, "Ubah Pemesanan", akses.getkode(), kdgudang.getText(), "Simpan");
                            ...
                            Sequel.menyimpan("history_user", "Now(),'" + NoFaktur.getText() + "','" + akses.getkode() + "','Ganti Data Pemesanan','Ganti'");
...
//                } else {
//                    JOptionPane.showMessageDialog(null, "Hubungi Admin Untuk MengEdit");
//                }
            }
        }
...
private void kdgudangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kdgudangKeyPressed
    ...
    private void btnSuplierActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSuplierActionPerformed
        akses.setform("DlgUbahPemesanan");
        suplier.emptTeks();
        suplier.isCek();
    ...
    public void isCek(String Faktur) {
        try {
            ...
            if (rs.next()) {
                ...
                ppnPctg = MathX.round((ppn / ttl) * 100, 1);
            }
        ...
        TCari.requestFocus();
        tppn.setText(String.valueOf(ppnPctg));
    }
