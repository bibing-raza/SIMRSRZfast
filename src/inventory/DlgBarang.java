...
public class DlgBarang extends javax.swing.JDialog {
    ...
    private double totalstok, stokgudang, dbRalan;
    ...
    private String kdlokasi = "", nmlokasi = "", tanggal = "0000-00-00",
            sql="select databarang.kode_brng, databarang.nama_brng, "
                ...
                + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan,databarang.tipe_brg,high_alert"
    ...
    public DlgBarang(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {
            ...
            "Kadaluwarsa","Kode I.F.","Industri Farmasi","Kode Kategori","Kategori","Kode Golongan","Golongan","Tipe Barang","High Alert"
        };
    ...
    private void initComponents() {
        ...
        cb_tipe_brg = new widget.ComboBox();
        jLabel33 = new widget.Label();
        cb_high = new widget.ComboBox();
        ...
        kelas1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kelas2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Letak.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ralan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        stok_minimal.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdjns.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmjns.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Kapasitas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kelas3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kelas3.setBounds(665, 12, 110, 23);
        ...
        utama.setForeground(new java.awt.Color(0, 0, 0));
        ...
        FormInput.add(utama);
        utama.setBounds(665, 42, 110, 23);

        kelasvip.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kelasvip.setBounds(665, 72, 110, 23);
        ...
        kelasvvip.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kelasvvip.setBounds(665, 102, 110, 23);
        ...
        beliluar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        beliluar.setBounds(665, 132, 110, 23);

        jualbebas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jualbebas.setBounds(665, 162, 110, 23);
        ...
        ChkKadaluarsa.setForeground(new java.awt.Color(0, 0, 0));
        ...
        nmgolongan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        kdgolongan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cb_tipe_brg.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cb_tipe_brgMouseClicked(evt);
            }
        });
        cb_tipe_brg.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cb_tipe_brgKeyPressed(evt);
            }
        });
        FormInput.add(cb_tipe_brg);
        cb_tipe_brg.setBounds(860, 220, 140, 23);

        jLabel33.setForeground(new java.awt.Color(0, 0, 0));
        jLabel33.setText("Tipe Barang :");
        jLabel33.setName("jLabel33"); // NOI18N
        FormInput.add(jLabel33);
        jLabel33.setBounds(740, 220, 115, 23);
        ...
        cb_high.addMouseListener(new java.awt.event.MouseAdapter() {
            public void mouseClicked(java.awt.event.MouseEvent evt) {
                cb_highMouseClicked(evt);
            }
        });
        cb_high.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                cb_highKeyPressed(evt);
            }
        });
        FormInput.add(cb_high);
        cb_high.setBounds(860, 250, 140, 23);

        jLabel34.setForeground(new java.awt.Color(0, 0, 0));
        jLabel34.setText("High Alert :");
        jLabel34.setName("jLabel34"); // NOI18N
        FormInput.add(jLabel34);
        jLabel34.setBounds(740, 250, 115, 23);
    ...
    private void BtnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapusActionPerformed
        if (akses.getnamauser().equals("Admin Utama")) {
            ...
            JOptionPane.showMessageDialog(null, "Hubungi Admin Untuk Menghapus");
        }       
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if(akses.getnamauser().equals("Admin Utama") || akses.getkode().equals(Sequel.cariIsi("select AES_DECRYPT(nip_admin_farmasi,'raza') from admin"))){
            ...
            Valid.editTable(tabMode, "databarang", "kode_brng", "?", "nama_brng=?,kode_brng=?,kapasitas=?,kode_sat=?,letak_barang=?,"
                    + "h_beli=?,ralan=?,kelas1=?,kelas2=?,stokminimal=?,kdjns=?,kelas3=?,utama=?,vip=?,vvip=?,beliluar=?,jualbebas=?,karyawan=?,expire=?,kode_industri=?,kode_kategori=?,kode_golongan=?, tipe_brg=?, high_alert=?", 25, new String[]{
                        ...
                        tanggal,KdIF.getText(),kdkategori.getText(),kdgolongan.getText(),cb_tipe_brg.getSelectedItem().toString(), cb_high.getSelectedItem().toString(),
            ...
            JOptionPane.showMessageDialog(null, "Hubungi Admin Untuk Mengganti");
        }
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if(akses.getnamauser().equals("Admin Utama") || akses.getkode().equals(Sequel.cariIsi("select AES_DECRYPT(nip_admin_farmasi,'raza') from admin"))){
            ...
            Sequel.menyimpan("databarang", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "Kode Barang", 25, new String[]{
                ...
                beliluar.getText().replaceAll(",", ""), jualbebas.getText().replaceAll(",", ""), karyawan.getText().replaceAll(",", ""),
                stok_minimal.getText(), kdjns.getText(), Kapasitas.getText(), tanggal,"1",KdIF.getText(),kdkategori.getText(),kdgolongan.getText(), cb_tipe_brg.getSelectedItem().toString(),
                cb_high.getSelectedItem().toString()
            });
            tampil();
            emptTeks();
        }
        }else{
            JOptionPane.showMessageDialog(null, "Hubungi Admin Untuk Menyimpan");
        }
...
//        }
    ...
    private void cb_tipe_brgItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_tipe_brgItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cb_tipe_brgItemStateChanged

    private void cb_tipe_brgMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cb_tipe_brgMouseClicked
        cb_tipe_brg.setEditable(false);
    }//GEN-LAST:event_cb_tipe_brgMouseClicked

    private void cb_tipe_brgKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cb_tipe_brgKeyPressed
//        Valid.pindah(evt, btnPenjab, no_telp);
    }//GEN-LAST:event_cb_tipe_brgKeyPressed

    private void cb_highItemStateChanged(java.awt.event.ItemEvent evt) {//GEN-FIRST:event_cb_highItemStateChanged
        // TODO add your handling code here:
    }//GEN-LAST:event_cb_highItemStateChanged

    private void cb_highMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_cb_highMouseClicked
        cb_tipe_brg.setEditable(false);
    }//GEN-LAST:event_cb_highMouseClicked

    private void cb_highKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_cb_highKeyPressed
//        Valid.pindah(evt, btnPenjab, no_telp);
    }//GEN-LAST:event_cb_highKeyPressed
    ...
    private widget.ComboBox cb_high;
    private widget.ComboBox cb_tipe_brg;
            ...
            try {
                ...
                while (rs.next()) {
                    tabMode.addRow(new Object[]{
                        ...
                        rs.getString("tipe_brg"),
                        rs.getString("high_alert")
                    });
                }
        ...
        if(akses.getform().equals("DlgReturJual")){
            ...
            try {
                ps4 = koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng, "
                        ...
                        + " where detail_pemberian_obat.no_rawat=? and databarang.nama_brng like ? "
    ...
    private void getData() {
        ...
        if (row != -1) {
            ...
            beli.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 6).toString()))));
            ralan.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 7).toString()))));
            kelas1.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 8).toString()))));
            kelas2.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 9).toString()))));
            kelas3.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 10).toString()))));
            utama.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 11).toString()))));
            kelasvip.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 12).toString()))));
            kelasvvip.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 13).toString()))));
            beliluar.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 14).toString()))));
            jualbebas.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 15).toString()))));
            karyawan.setText(String.format ("%.0f",(Double.parseDouble(tbDokter.getValueAt(row, 16).toString()))));
            ...
            cb_tipe_brg.setSelectedItem(tbDokter.getValueAt(row, 28).toString());
            cb_high.setSelectedItem(tbDokter.getValueAt(row, 29).toString());
    ...
    private void isHitung() {
        try {
            ...
            while (rs.next()) {
                if (!beli.getText().equals("")) {                      
                    ralan.setText(String.format ("%.0f",(Valid.roundUp(Double.valueOf(beli.getText()) + (Double.valueOf(beli.getText()) * (rs.getDouble("ralan") / 100)),100))));
                    kelas1.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("kelas1") / 100)),100))));
                    kelas2.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("kelas2") / 100)),100))));
                    kelas3.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("kelas3") / 100)),100))));
                    utama.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("utama") / 100)),100))));
                    kelasvip.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("vip") / 100)),100))));
                    kelasvvip.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("vvip") / 100)),100))));
                    beliluar.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("beliluar") / 100)),100))));
                    jualbebas.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("jualbebas") / 100)),100))));
                    karyawan.setText(String.format("%.0f",(Valid.roundUp(Double.parseDouble(beli.getText()) + (Double.parseDouble(beli.getText()) * (rs.getDouble("karyawan") / 100)),100))));
                }
            }
            //rs.close();
        } catch (Exception e) {
    ...
    public void tampil5(String NoRetur) {
        retNo = NoRetur;
        if(akses.getform().equals("DlgReturBeli")){
            ...
            try {
                ps4 = koneksi.prepareStatement("select databarang.kode_brng, databarang.nama_brng, "
                        ...
                        + " jenis.nama,kapasitas,databarang.expire,databarang.kode_industri,industrifarmasi.nama_industri, "
                        + " databarang.kode_kategori,kategori_barang.nama as kategori,databarang.kode_golongan,golongan_barang.nama as golongan  "
                        + " from databarang inner join kodesatuan inner join jenis inner join detailpesan inner join industrifarmasi inner join golongan_barang inner join kategori_barang"
                        + " on databarang.kode_sat=kodesatuan.kode_sat and databarang.kdjns=jenis.kdjns and "
                        + " databarang.kode_golongan=golongan_barang.kode and databarang.kode_kategori=kategori_barang.kode and "
                        + " detailpesan.kode_brng=databarang.kode_brng and databarang.kode_industri=industrifarmasi.kode_industri "
                        + " where detailpesan.no_faktur=? and databarang.nama_brng like ? "
                        + " group by databarang.kode_brng order by databarang.nama_brng");
                try {
                    ps4.setString(1,NoRetur);
                    ps4.setString(2, "%" + TCari.getText().trim() + "%");
