...
public class INACBGCoderNIK extends javax.swing.JDialog {
    ...
    public INACBGCoderNIK(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"NIP","Petugas","Coder NIK","Status"};
        ...
        pegawai.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(pegawai.getTable().getSelectedRow()!= -1){                   
                    NIK.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),0).toString());
                    Nama.setText(pegawai.tbPegawai.getValueAt(pegawai.tbPegawai.getSelectedRow(),1).toString());                                        
                }   
                NIK.requestFocus();
            }
            @Override
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ NIK Petugas Coder INACBG ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        CoderNIK.setForeground(new java.awt.Color(0, 0, 0));
        ...
        cmbStatus.setBounds(485, 42, 100, 23);

        jLabel5.setForeground(new java.awt.Color(0, 0, 0));
        jLabel5.setText("Status : ");
        jLabel5.setName("jLabel5"); // NOI18N
        panelGlass7.add(jLabel5);
        jLabel5.setBounds(420, 42, 60, 23);
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (NIK.getText().trim().equals("") || Nama.getText().trim().equals("")) {
            ...
            Valid.textKosong(CoderNIK, "NIK Petugas Coder");
        } else if (cmbStatus.getSelectedItem().equals(" ")) {
            Valid.textKosong(cmbStatus, "Status Coder");
        } else {
            cekStatus = "";
            ...
            Sequel.menyimpan("inacbg_coder_nik", "'" + NIK.getText() + "',"
                    + "'" + CoderNIK.getText() + "','" + cekStatus + "'", "NIP");
            tampil();
            emptTeks();
        }
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (NIK.getText().trim().equals("") || Nama.getText().trim().equals("")) {
            ...
            Valid.editTable(tabMode, "inacbg_coder_nik", "nik", NIK,
                    "no_ik='" + CoderNIK.getText() + "',status='" + cekStatus + "'");
    ...
    */
    ...
    private void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select inacbg_coder_nik.nik,pegawai.nama,inacbg_coder_nik.no_ik, if(inacbg_coder_nik.status='1','Aktif','Non Aktif') status "
                    + "from inacbg_coder_nik inner join pegawai on inacbg_coder_nik.nik=pegawai.nik where "
                    + "pegawai.nama like ? or inacbg_coder_nik.no_ik like ? or "
                    + "if(inacbg_coder_nik.status='1','Aktif','Non Aktif') like ? order by pegawai.nama");
            try {
    ...
    private void getData() {
        ...
        if (tbSpesialis.getSelectedRow() != -1) {
            ...
            cmbStatus.setSelectedItem(tbSpesialis.getValueAt(tbSpesialis.getSelectedRow(), 3).toString());
