...
public class KendaliMutuKendaliBiayaJKN extends javax.swing.JDialog {
    ...
    private String nmRawat = "", unitnya = "", dokternya = "", dialog_simpan = "";
    ...
    private void initComponents() {
        ...
        MnExportkeExcel.setBackground(new java.awt.Color(242, 242, 242));
        ...
        MnExportkeExcel.setPreferredSize(new java.awt.Dimension(220, 26));
        ...
        tbKendaliKlaim.setComponentPopupMenu(jPopupMenu1);
...
*/
    ...
    private void formWindowOpened(java.awt.event.WindowEvent evt) {//GEN-FIRST:event_formWindowOpened
        Sequel.cariIsiComboDB("SELECT IF(nm_gedung='-','PERINATOLOGI',nm_gedung) FROM bangsal GROUP BY nm_gedung", cmbRuangan);
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            if (jnsRawat.getSelectedIndex() == 1) {
                ...
                if ((cmbRuangan.getSelectedItem().equals("-"))) {
                    unitnya = "IF(rp.status_lanjut='Ralan',p.nm_poli, (SELECT IF(b.nm_gedung='-','PERINATOLOGI',b.nm_gedung) FROM kamar_inap ki "
            ...
            Valid.MyReportToExcel("SELECT enc.no_sep 'No. SEP', enc.no_rm 'No. RM',enc.nm_pasien 'Nama Pasien', IF(rp.status_lanjut='Ralan',p.nm_poli, (SELECT IF(b.nm_gedung='-','PERINATOLOGI',b.nm_gedung) FROM kamar_inap ki "
                    + "INNER JOIN kamar k ON k.kd_kamar=ki.kd_kamar INNER JOIN bangsal b ON b.kd_bangsal=k.kd_bangsal WHERE no_rawat=rp.no_rawat AND ki.stts_pulang<>'Pindah Kamar')) 'Poli/Inst./Rg./Gedung Inap', "
                    + "IF(rp.status_lanjut='Ralan',d.nm_dokter,(SELECT d.nm_dokter FROM dpjp_ranap dr INNER JOIN dokter d ON d.kd_dokter=dr.kd_dokter WHERE dr.no_rawat=rp.no_rawat)) 'Nama DPJP', "
                    + "esc.tarif_obat 'Biaya Real Obat',concat('   ',enc.klaim_final) 'Status Klaim',eg.cbg_desc 'Deskripsi CBG',eg.cbg_tarif 'Tarif CBG', IFNULL(egsc.desc,'-') 'Deskripsi TopUp', IFNULL(egsc.tarif,0) 'TopUp Tarif', "
                    + "IFNULL(eg.cbg_tarif+egsc.tarif,eg.cbg_tarif) 'Tot. Trf. Grouping', CONCAT('   ',FORMAT((esc.tarif_obat/ IFNULL(eg.cbg_tarif+egsc.tarif,eg.cbg_tarif))*100,2),' ','%') 'Pemakaian Obat (%)' "
                    ...
                    + "rp.status_lanjut like '%" + nmRawat + "%' and " + unitnya + " and " + dokternya + " and "
    ...
    */
    ...
    public void tampil() {
        ...
        try {
            ps = koneksi.prepareStatement("SELECT enc.no_sep,enc.no_rm,enc.nm_pasien, IF(rp.status_lanjut='Ralan',p.nm_poli, (SELECT IF(b.nm_gedung='-','PERINATOLOGI',b.nm_gedung) FROM kamar_inap ki "
