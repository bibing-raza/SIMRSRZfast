...
public class frmUtama extends javax.swing.JFrame {
    ...
    private final DlgDashboardEresep dash = new DlgDashboardEresep(this, false);
    ...
    private void initComponents() {
        ...
        MnKomunikasi = new javax.swing.JMenuItem();
        ...
        MnSudahPulang7 = new javax.swing.JMenuItem();
        ...
        internalFrame3.setBorder(javax.swing.BorderFactory.createTitledBorder(new javax.swing.border.LineBorder(new java.awt.Color(100, 125, 90), 1, true), ":: Silahkan Anda Login ::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        internalFrame6.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Ubah Password ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12))); // NOI18N
        ...
        btnRekapPresensi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnfee_rujukan_ranap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnPenilaianAwalMedisKebidananRalan.setForeground(new java.awt.Color(0, 0, 0));
        btnPenilaianAwalMedisKebidananRalan.setIcon(new javax.swing.ImageIcon(getClass().getResource("/48x48/pregnant_woman.png"))); // NOI18N
        btnPenilaianAwalMedisKebidananRalan.setText("Penilaian Awal Medis Kebidanan Ralan");
        btnPenilaianAwalMedisKebidananRalan.setIconTextGap(0);
        btnPenilaianAwalMedisKebidananRalan.setName("btnPenilaianAwalMedisKebidananRalan"); // NOI18N
        btnPenilaianAwalMedisKebidananRalan.setPreferredSize(new java.awt.Dimension(200, 90));
        btnPenilaianAwalMedisKebidananRalan.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnPenilaianAwalMedisKebidananRalanActionPerformed(evt);
            }
        });
        ...
        btnBridgingEklaim.setVerticalAlignment(javax.swing.SwingConstants.TOP);
        ...
        btnToolBcdRanap.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MnLogin.setPreferredSize(new java.awt.Dimension(180, 35));
        ...
        MnGantiPassword.setPreferredSize(new java.awt.Dimension(180, 35));
        ...
        MnKomunikasi.setBackground(new java.awt.Color(255, 255, 255));
        MnKomunikasi.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnKomunikasi.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/couple24.png"))); // NOI18N
        MnKomunikasi.setText("Komunikasi");
        MnKomunikasi.setIconTextGap(6);
        MnKomunikasi.setName("MnKomunikasi"); // NOI18N
        MnKomunikasi.setPreferredSize(new java.awt.Dimension(180, 35));
        MnKomunikasi.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnKomunikasiBtnLogActionPerformed(evt);
            }
        });
        jMenu1.add(MnKomunikasi);
        ...
        MenuKeluar.setPreferredSize(new java.awt.Dimension(180, 35));
        ...
        jMenu5.setPreferredSize(new java.awt.Dimension(145, 30));
        ...
        jMenu6.setPreferredSize(new java.awt.Dimension(98, 30));

        MnJadwalDokterRalan.setBackground(new java.awt.Color(255, 255, 255));
        ...
        MnTelusurKunjungan.setBackground(new java.awt.Color(255, 255, 255));
        ...
        MnSudahPulang7.setBackground(new java.awt.Color(255, 255, 255));
        MnSudahPulang7.setFont(new java.awt.Font("Tahoma", 0, 11)); // NOI18N
        MnSudahPulang7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/Preview.png"))); // NOI18N
        MnSudahPulang7.setText("Tarif INACBG's Klaim BPJS");
        MnSudahPulang7.setIconTextGap(6);
        MnSudahPulang7.setName("MnSudahPulang7"); // NOI18N
        MnSudahPulang7.setPreferredSize(new java.awt.Dimension(250, 35));
        MnSudahPulang7.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                MnSudahPulang7ActionPerformed(evt);
            }
        });
        jMenu6.add(MnSudahPulang7);
    ...
    private void BtnToolKamnapActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnToolKamnapActionPerformed
        ...
        kasirralan.kamarinap.UserValid();
        DlgHome.dispose();
...
private void BtnToolRegActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnToolRegActionPerformed
    this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    isTutup();
    kasirralan.kamarinap.reg.tRefreshAntri.start();
...
private void BtnSimpanPassKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnSimpanPassKeyPressed
    ...
    private void btnRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRalanActionPerformed
        isTutup();
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        kasirralan.billing.dlgrwjl.tampilDrPr();
    ...
    private void btnJnsBarangActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnJnsBarangActionPerformed
        ...
        isTutup();
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        kasirralan.billing.dlgobt.barang.jenis.isCek();
        kasirralan.billing.dlgobt.barang.jenis.emptTeks();
        kasirralan.billing.dlgobt.barang.jenis.setSize(PanelUtama.getWidth(), PanelUtama.getHeight());
        kasirralan.billing.dlgobt.barang.jenis.setLocationRelativeTo(PanelUtama);
        kasirralan.billing.dlgobt.barang.jenis.setVisible(true);
        DlgHome.dispose();
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnKomunikasiBtnLogActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnKomunikasiBtnLogActionPerformed
        JOptionPane.showMessageDialog(null, "Untuk sementara menu ini masih dalam tahap pengembangan ...!");
//        if (BtnLog.getText().equals("Log In")) {
//            JOptionPane.showMessageDialog(null, "Untuk berkomunikasi dengan petugas yang lain silakan Login dulu ...!");            
//        } else {
//            frmPengaduan pengaduan = new frmPengaduan();
//            pengaduan.setSize(990, 650);
//            pengaduan.setLocationRelativeTo(null);
//            pengaduan.isCek();
//            pengaduan.setVisible(true);
//            pengaduan.fokus();
//        }
    }//GEN-LAST:event_MnKomunikasiBtnLogActionPerformed
...
//        form.setVisible(true);
    ...
    private void btnDataGiziBurukActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnDataGiziBurukActionPerformed
        ...
        kasirralan.kamarinap.isCek();
        kasirralan.kamarinap.emptTeks();
        kasirralan.kamarinap.emptGZburuk();
        kasirralan.kamarinap.tampilGZburuk();
        kasirralan.kamarinap.TCari3.requestFocus();
        kasirralan.kamarinap.WindowGiziBuruk.setSize(PanelUtama.getWidth(), PanelUtama.getHeight());
        kasirralan.kamarinap.WindowGiziBuruk.setLocationRelativeTo(PanelUtama);
        kasirralan.kamarinap.WindowGiziBuruk.setVisible(true);
        kasirralan.kamarinap.ChkInput.setSelected(false);
        kasirralan.kamarinap.isForm();
        kasirralan.kamarinap.BtnSimpan7.setEnabled(false);
        kasirralan.kamarinap.BtnHapus.setEnabled(true);
        kasirralan.kamarinap.BtnEdit2.setEnabled(true);
        DlgHome.dispose();
        this.setCursor(Cursor.getDefaultCursor());
    ...
    private void MnSudahPulang7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnSudahPulang7ActionPerformed
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
        DlgHome.dispose();
        ...
        belum.setVisible(true);
        this.setCursor(Cursor.getDefaultCursor());
    }//GEN-LAST:event_MnSudahPulang7ActionPerformed
    ...
    private void btnMonevAsuhanGiziActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMonevAsuhanGiziActionPerformed
        ...
        monevGZ.ChkInput.setSelected(false);
        monevGZ.isForm();
        monevGZ.tampil();
    ...
    private void btnPenilaianAwalMedisKebidananRalanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPenilaianAwalMedisKebidananRalanActionPerformed
        isTutup();
        DlgHome.dispose();
        this.setCursor(Cursor.getPredefinedCursor(Cursor.WAIT_CURSOR));
    ...
    private javax.swing.JMenuItem MnKomunikasi;
    ...
    private javax.swing.JMenuItem MnSudahPulang7;
    ...
    private void isTutup() {
        ...
        kasirralan.kamarinap.reg.tRefreshAntri.stop();
        dash.tEresep.stop();
        FlayMenu.setVisible(false);
    ...
    private void setToolbar() {
        ...
        if (internalFrame1.getWidth() < (BtnMenu.getWidth() + BtnToolReg.getWidth() + btnToolIGD.getWidth()
                + btnBridgingEklaim.getWidth() + btnToolBcdRanap.getWidth() + btnToolLab.getWidth()
    ...
    private void isCombo() {
        if (cmbMenu.getSelectedIndex() == 0) {
            ...
            if (akses.getfee_rujukan_ranap() == true) {
                Panelmenu.add(btnfee_rujukan_ranap);
                jmlmenu++;
            }
