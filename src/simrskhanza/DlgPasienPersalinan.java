...
public class DlgPasienPersalinan extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnPrinDataPersalinan.setBackground(new java.awt.Color(255, 255, 255));
        ...
        MnPrinDataPersalinan.setPreferredSize(new java.awt.Dimension(220, 26));
        ...
        MnPrinRekapTotal.setBackground(new java.awt.Color(255, 255, 255));
        ...
        MnPrinRekapTotal.setPreferredSize(new java.awt.Dimension(220, 26));
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void MnPrinDataPersalinanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPrinDataPersalinanActionPerformed
        ...
        cekData = Sequel.cariInteger("SELECT count(1) cek FROM data_persalinan ds INNER JOIN pasien p ON p.no_rkm_medis = ds.no_rkm_medis "
                ...
                + "WHERE ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi BETWEEN '" + Valid.SetTgl(DTPCari1.getSelectedItem() + "") + "' AND '" + Valid.SetTgl(DTPCari2.getSelectedItem() + "") + "'");
        ...
        if (tabMode.getRowCount() == 0) {
            ...
            Valid.MyReport("rptDataPersalinan.jasper", "report", "::[ Data Persalinan Pasien ]::",
                    ...
                    + "LEFT JOIN dokter d ON d.kd_dokter = dr.kd_dokter WHERE ki.stts_pulang not in ('-','pindah kamar') and "
        ...
        try {
            if (cmbLimit.getSelectedItem().toString().equals("Semua") && stsPulang.equals("")) {
                ps = koneksi.prepareStatement("SELECT ds.no_rawat, ds.no_rkm_medis, CONCAT(p.nm_pasien,' (',r.umurdaftar,' ',r.sttsumur,'.)') pasien, ds.jns_persalinan, ds.rujukan, "
                        ...
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.no_rawat like ? OR "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.no_rkm_medis LIKE ? OR "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.jns_persalinan LIKE ? OR "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.rujukan LIKE ? OR "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and p.nm_pasien LIKE ? or "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and pj.png_jawab LIKE ? or "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and b.nm_bangsal LIKE ? or "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ki.stts_pulang LIKE ? or "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and d.nm_dokter LIKE ? ORDER BY ds.no_rawat DESC");
                ...
                ps = koneksi.prepareStatement("SELECT ds.no_rawat, ds.no_rkm_medis, CONCAT(p.nm_pasien,' (',r.umurdaftar,' ',r.sttsumur,'.)') pasien, ds.jns_persalinan, ds.rujukan, "
                        ...
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and b.nm_bangsal LIKE ? or "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ki.stts_pulang LIKE ? or "
                        + "ki.stts_pulang not in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and d.nm_dokter LIKE ? "
            ...
            if ((stsPulang.equals("-") || stsPulang.equals("Pindah Kamar")) && cmbLimit.getSelectedItem().toString().equals("Semua")) {
                ps = koneksi.prepareStatement("SELECT ds.no_rawat, ds.no_rkm_medis, CONCAT(p.nm_pasien,' (',r.umurdaftar,' ',r.sttsumur,'.)') pasien, ds.jns_persalinan, ds.rujukan, "
                        ...
                        + "INNER JOIN kamar k on k.kd_kamar=ki.kd_kamar INNER JOIN bangsal b on b.kd_bangsal=k.kd_bangsal INNER JOIN penjab pj on pj.kd_pj=r.kd_pj "
                        + "LEFT JOIN dpjp_ranap dr on dr.no_rawat=ki.no_rawat LEFT JOIN dokter d on d.kd_dokter=dr.kd_dokter WHERE "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.no_rawat like ? OR "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.no_rkm_medis LIKE ? OR "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.jns_persalinan LIKE ? OR "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ds.rujukan LIKE ? OR "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and p.nm_pasien LIKE ? or "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and pj.png_jawab LIKE ? or "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and b.nm_bangsal LIKE ? or "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ki.stts_pulang LIKE ? or "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and d.nm_dokter LIKE ? ORDER BY ds.no_rawat DESC");
                ...
                ps = koneksi.prepareStatement("SELECT ds.no_rawat, ds.no_rkm_medis, CONCAT(p.nm_pasien,' (',r.umurdaftar,' ',r.sttsumur,'.)') pasien, ds.jns_persalinan, ds.rujukan, "
                        ...
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and b.nm_bangsal LIKE ? or "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and ki.stts_pulang LIKE ? or "
                        + "ki.stts_pulang in ('-','pindah kamar') and r.tgl_registrasi between ? and ? and d.nm_dokter LIKE ? "
                        + "ORDER BY ds.no_rawat DESC limit " + cmbLimit.getSelectedItem() + "");
            }
