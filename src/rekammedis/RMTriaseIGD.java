...
public final class RMTriaseIGD extends javax.swing.JDialog {
    ...
    private int i = 0, jml = 0, index = 0, jmlskala1 = 0, jmlskala2 = 0, jmlskala3 = 0,
            jmlskala4 = 0, jmlskala5 = 0, cek2 = 0;
    private MasterTriaseMacamKasus kasus = new MasterTriaseMacamKasus(null, false);
    private boolean[] pilih;
    private String[] kode, pengkajian;
    private DlgCariPetugas petugas = new DlgCariPetugas(null, false);
    private String keputusan = "", pilihan = "", datatriase = "", cek1 = "";
        ...
        petugas.addWindowListener(new WindowListener() {
            ...
            public void windowClosed(WindowEvent e) {
                if(petugas.getTable().getSelectedRow()!= -1){       
                    if(index==1){
                        PrimerKodePetugas.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),0).toString());
                        PrimerNamaPetugas.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),1).toString());
                        btnPrimerPetugas.requestFocus();
                    }else if(index==2){
                        SekunderKodePetugas.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),0).toString());
                        SekunderNamaPetugas.setText(petugas.getTable().getValueAt(petugas.getTable().getSelectedRow(),1).toString());
    ...
    private void initComponents() {
        ...
        PrimerKebutuhanKusus = new widget.ComboBox();
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Data Triase IGD ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        internalFrame1.setFont(new java.awt.Font("Tahoma", 2, 12)); // NOI18N
        internalFrame1.setName("internalFrame1"); // NOI18N
        internalFrame1.setLayout(new java.awt.BorderLayout(1, 1));

        TabPilihan.setBackground(new java.awt.Color(255, 255, 254));
        TabPilihan.setForeground(new java.awt.Color(0, 0, 0));
        TabPilihan.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        TabTriase.setForeground(new java.awt.Color(0, 0, 0));
        TabTriase.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        PrimerKebutuhanKusus.setForeground(new java.awt.Color(0, 0, 0));
        PrimerKebutuhanKusus.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "-", "UPPA", "Airborne", "Dekontaminan" }));
        PrimerKebutuhanKusus.setName("PrimerKebutuhanKusus"); // NOI18N
        PrimerKebutuhanKusus.setPreferredSize(new java.awt.Dimension(55, 28));
        PrimerKebutuhanKusus.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                PrimerKebutuhanKususKeyPressed(evt);
            }
        });
        internalFrame7.add(PrimerKebutuhanKusus);
        PrimerKebutuhanKusus.setBounds(483, 70, 202, 23);

        jLabel10.setForeground(new java.awt.Color(0, 0, 0));
        jLabel10.setText("Suhu (°C) :");
        jLabel10.setName("jLabel10"); // NOI18N
        internalFrame7.add(jLabel10);
        jLabel10.setBounds(420, 10, 80, 23);

        PrimerSuhu.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerSuhu.setBounds(505, 10, 55, 23);
        ...
        PrimerSaturasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel25.setBounds(570, 10, 70, 23);

        PrimerNyeri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerNyeri.setBounds(645, 10, 55, 23);

        PrimerNadi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerNadi.setBounds(645, 40, 55, 23);

        jLabel26.setForeground(new java.awt.Color(0, 0, 0));
        jLabel26.setText("Nadi (/menit) :");
        jLabel26.setName("jLabel26"); // NOI18N
        internalFrame7.add(jLabel26);
        jLabel26.setBounds(570, 40, 70, 23);

        PrimerRespirasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerTensi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerTensi.setBounds(505, 40, 60, 23);

        jLabel11.setForeground(new java.awt.Color(0, 0, 0));
        jLabel11.setText("Tensi (mmHg) :");
        jLabel11.setName("jLabel11"); // NOI18N
        internalFrame7.add(jLabel11);
        jLabel11.setBounds(420, 40, 80, 23);
        ...
        PrimerKodePetugas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerNamaPetugas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        btnPrimerPetugas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PrimerTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2020 17:27:09" }));
        ...
        PrimerResusitasi.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        PrimerKritis.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        ...
        PrimerCatatan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TCariPemeriksaan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnCariPemeriksaan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnTambahPemeriksaan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TCariSkala1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TabSkala1dan2.setForeground(new java.awt.Color(0, 0, 0));
        TabSkala1dan2.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        tbSkala1.setSelectionForeground(new java.awt.Color(0, 0, 204));
        ...
        tbSkala2.setSelectionForeground(new java.awt.Color(0, 0, 204));
        ...
        jLabel14.setBounds(566, 10, 60, 23);

        SekunderSuhu.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderSaturasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderNyeri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderNadi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderRespirasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderTensi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel15.setText("Tensi (mmHg) :");
        jLabel15.setName("jLabel15"); // NOI18N
        internalFrame11.add(jLabel15);
        jLabel15.setBounds(374, 70, 80, 23);
        ...
        SekunderKodePetugas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderNamaPetugas.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SekunderTanggalTriase.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2020 17:27:09" }));
        ...
        SekunderZonaKuning.setBackground(new java.awt.Color(0, 0, 0));
        buttonGroup1.add(SekunderZonaKuning);
        SekunderZonaKuning.setForeground(new java.awt.Color(255, 255, 0));
        SekunderZonaKuning.setText("Zona Kuning");
        SekunderZonaKuning.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        SekunderZonaKuning.setName("SekunderZonaKuning"); // NOI18N
        SekunderZonaKuning.setOpaque(true);
        SekunderZonaKuning.setPreferredSize(new java.awt.Dimension(40, 20));
        internalFrame12.add(SekunderZonaKuning);
        SekunderZonaKuning.setBounds(456, 10, 110, 23);

        SekunderZonaHijau.setBackground(new java.awt.Color(0, 0, 0));
        buttonGroup1.add(SekunderZonaHijau);
        SekunderZonaHijau.setForeground(new java.awt.Color(0, 255, 51));
        SekunderZonaHijau.setText("Zona Hijau");
        SekunderZonaHijau.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        SekunderZonaHijau.setName("SekunderZonaHijau"); // NOI18N
        SekunderZonaHijau.setOpaque(true);
        ...
        SekunderCatatan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TCariPemeriksaan2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TCariSkala3.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TabSkala3dan4dan5.setForeground(new java.awt.Color(0, 0, 0));
        TabSkala3dan4dan5.setFont(new java.awt.Font("Tahoma", 1, 12)); // NOI18N
        ...
        tbSkala3.setSelectionForeground(new java.awt.Color(0, 0, 255));
        ...
        tbSkala4.setSelectionForeground(new java.awt.Color(0, 0, 255));
        ...
        tbSkala5.setSelectionForeground(new java.awt.Color(0, 0, 255));
        ...
        TanggalKunjungan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2020 17:27:09" }));
        ...
        CaraMasuk.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Transportasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AlasanKedatangan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KeteranganKedatangan.setForeground(new java.awt.Color(0, 0, 0));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "26-02-2020" }));
        ...
        LoadHTML.setSelectionColor(new java.awt.Color(0, 0, 0));
        ...
        if (TNoRw.getText().trim().equals("") || TPasien.getText().trim().equals("")) {
            ...
            if (TabTriase.getSelectedIndex() == 0) {
                ...
                if (PrimerKeluhanUtama.getText().trim().equals("")) {
                    ...
                    Valid.textKosong(btnPrimerPetugas, "Petugas Primer");
                    ...
                    if (Sequel.menyimpantf("data_triase_igd", "?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 13, new String[]{
                        ...
                        Sequel.menyimpan("data_triase_igdprimer", "?,?,?,?,?,?,?", 7, new String[]{
                            TNoRw.getText(), PrimerKeluhanUtama.getText(), PrimerKebutuhanKusus.getSelectedItem().toString(), PrimerCatatan.getText(), keputusan,
                ...
                if (SekunderAnamnesa.getText().trim().equals("")) {
                    ...
                    Valid.textKosong(btnSekunderPetugas, "Petugas Sekunder");
            ...
            switch (keputusan) {
                case "Laporan 1":
                    ...
                    Valid.MyReportqry("rptDataTriaseIGD.jasper", "report", "::[ Data Triase IGD ]::",
                            "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,date_format(data_triase_igd.tgl_kunjungan,'%d-%m-%Y %h:%m %p') tgl_kunjungan,"
                                    ...
                                    htmlContent.append(
                                        "<td valign='top' cellpadding='0' cellspacing='0'>"+
                                            "<table width='100%' border='0' cellpadding='0' cellspacing='0' align='center'>"+
                                                ...
                                                "</tr>"+
                                                "<tr class='isi2'>"+
                                                    "<td width='34%' valign='top'>Nama Petugas</td><td valign='top'>:&nbsp;</td><td width='65%' valign='top'>"+rs.getString("nip")+" "+Sequel.cariIsi("select nama from petugas where nip=?",rs.getString("nip"))+"</td>"+
                                                "</tr>"+
                                            "</table>"+
                                        "</td>"
                                    );
                    ...
                    try {
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                PrimerKebutuhanKusus.setSelectedItem(rs.getString("kebutuhan_khusus"));
                                ...
                                PrimerKodePetugas.setText(rs.getString("nip"));
                                PrimerNamaPetugas.setText(Sequel.cariIsi("select nama from petugas where nip=?",rs.getString("nip")));
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        } finally{
                        ...
                        try {
                            ...
                            if(rs.next()){
                                ...
                                SekunderKodePetugas.setText(rs.getString("nip"));
                                SekunderNamaPetugas.setText(Sequel.cariIsi("select nama from petugas where nip=?",rs.getString("nip")));
                            }
                        } catch (Exception e) {
                            System.out.println("Notifikasi : "+e);
                        } finally{
    ...
    private void PrimerRespirasiKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerRespirasiKeyPressed
        Valid.pindah(evt,PrimerSaturasi,PrimerKebutuhanKusus);
    ...
    private void TCariPemeriksaanKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TCariPemeriksaanKeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_ENTER){
            ...
            PrimerKebutuhanKusus.requestFocus();
        }
    ...
    private void TabSkala1dan2MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabSkala1dan2MouseClicked
        if (TabSkala1dan2.getSelectedIndex() == 0) {
            label11.setForeground(new Color(170, 0, 0));
            BtnTambahSkala1.setEnabled(akses.getmaster_triase_skala1());
            PrimerResusitasi.setSelected(true);
        } else if (TabSkala1dan2.getSelectedIndex() == 1) {
            label11.setForeground(new Color(250, 0, 0));
    ...
    private void TabSkala3dan4dan5MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_TabSkala3dan4dan5MouseClicked
        if (TabSkala3dan4dan5.getSelectedIndex() == 0) {
            ...
            label13.setForeground(new Color(0, 255, 51));
...
//       Valid.pindah(evt,KeteranganKedatangan,PrimerSuhu);
    ...
    private void PrimerKebutuhanKususKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_PrimerKebutuhanKususKeyPressed
        Valid.pindah(evt,PrimerRespirasi,TCariPemeriksaan);
    }//GEN-LAST:event_PrimerKebutuhanKususKeyPressed
        ...
        if(TNoRM1.getText().trim().equals("")||TPasien1.getText().trim().equals("")){
            ...
            if(tbTriase.getSelectedRow()> -1){
                ...
                if(LoadHTML.getText().contains("#AA0000")){
                    ...
                    param.put("logo", Sequel.cariGambar("select logo from setting"));
                    try {
                        ps = koneksi.prepareStatement("select data_triase_igdprimer.keluhan_utama,data_triase_igdprimer.kebutuhan_khusus,data_triase_igdprimer.catatan,"
                                + "data_triase_igdprimer.plan,data_triase_igdprimer.tanggaltriase,data_triase_igdprimer.nip,data_triase_igd.tekanan_darah,"
                                + "data_triase_igd.nadi,data_triase_igd.pernapasan,data_triase_igd.suhu,data_triase_igd.saturasi_o2,data_triase_igd.nyeri,"
                                + "data_triase_igd.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,pasien.jk,pasien.tgl_lahir,petugas.nama,data_triase_igd.tgl_kunjungan, "
                                + "data_triase_igd.cara_masuk,master_triase_macam_kasus.macam_kasus from data_triase_igdprimer inner join data_triase_igd "
                                + "inner join pasien inner join petugas inner join reg_periksa inner join master_triase_macam_kasus on "
                                + "data_triase_igd.no_rawat=data_triase_igdprimer.no_rawat and reg_periksa.no_rawat=data_triase_igd.no_rawat "
                                + "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and petugas.nip=data_triase_igdprimer.nip "
                        ...
                        try {
                            ...
                            if (rs.next()) {
                                ...
                                param.put("tandavital", "Suhu (C) : " + rs.getString("suhu") + ", Nyeri : " + rs.getString("nyeri")
                                        + ", Tensi : " + rs.getString("tekanan_darah") + ", Nadi(/menit) : " + rs.getString("nadi")
                                        + ", Saturasi O²(%) : " + rs.getString("saturasi_o2") + ", Respirasi(/menit) : " + rs.getString("pernapasan"));
                                param.put("finger", Sequel.cariIsi("select sha1(sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?", rs.getString("nip")));
                                ps2 = koneksi.prepareStatement("select master_triase_pemeriksaan.kode_pemeriksaan,master_triase_pemeriksaan.nama_pemeriksaan "
                                        + "from master_triase_pemeriksaan inner join master_triase_skala1 inner join data_triase_igddetail_skala1 "
                                        + "on master_triase_pemeriksaan.kode_pemeriksaan=master_triase_skala1.kode_pemeriksaan and "
                                        + "master_triase_skala1.kode_skala1=data_triase_igddetail_skala1.kode_skala1 where data_triase_igddetail_skala1.no_rawat=? "
                                        + "group by master_triase_pemeriksaan.kode_pemeriksaan order by master_triase_pemeriksaan.kode_pemeriksaan");
                                try {
                                    ...
                                    while (rs2.next()) {
                                        datatriase = "";
                                        ps3 = koneksi.prepareStatement("select master_triase_skala1.pengkajian_skala1 from master_triase_skala1 inner join data_triase_igddetail_skala1 "
                                                + "on master_triase_skala1.kode_skala1=data_triase_igddetail_skala1.kode_skala1 where "
                                                + "master_triase_skala1.kode_pemeriksaan=? and data_triase_igddetail_skala1.no_rawat=? "
                                                + "order by data_triase_igddetail_skala1.kode_skala1");
                                        try {
                    ...
                    try {
                        ps=koneksi.prepareStatement(
                            ...
                            "and reg_periksa.no_rkm_medis=pasien.no_rkm_medis and petugas.nip=data_triase_igdsekunder.nip "+
                            "and master_triase_macam_kasus.kode_kasus=data_triase_igd.kode_kasus where data_triase_igd.no_rawat=?");
                        try {
                            ps.setString(1,tbTriase.getValueAt(tbTriase.getSelectedRow(),0).toString());
                            rs=ps.executeQuery();
    ...
    */
    ...
    private widget.ComboBox PrimerKebutuhanKusus;
    ...
    private void emptTeks(){
        ...
        PrimerKebutuhanKusus.setSelectedIndex(0);
    ...
    public void setNoRm(String norwt,String norm,String namapasien) {
        cek1 = "";
        cek2 = 0;
        cek1 = Sequel.cariIsi("select datang_sendiri from data_igd where no_rawat='" + norwt + "'");
        cek2 = Sequel.cariInteger("select count(1) cek from pemeriksaan_ralan_petugas where no_rawat='" + norwt + "'");
        
        if (cek1.equals("Tidak")) {
            emptTeks();
            TNoRw.setText(norwt);
            TNoRM.setText(norm);
            TPasien.setText(namapasien);
            TCari.setText(norwt);
        } else if (cek1.equals("Ya")) {
            emptTeks();
            AlasanKedatangan.setSelectedItem("Datang Sendiri");
            TNoRw.setText(norwt);
            TNoRM.setText(norm);
            TPasien.setText(namapasien);
            TCari.setText(norwt);
                    ...
                    if(rs.next()){
                        ...
                        htmlContent.append(    
                            ...
                            "<tr class='isi'>"+
                                ...
                                "<td valign='middle'>"+rs.getString("nip")+" "+Sequel.cariIsi("select nama from petugas where nip=?",rs.getString("nip"))+"</td>"+
                            "</tr>"
                        );
    ...
    private void cekPemeriksaanPetugas() {
        try {
            ps4 = koneksi.prepareStatement("select tgl_perawatan, jam_rawat, suhu_tubuh, tensi, nadi, respirasi, tinggi, berat, "
            ...
            try {
                ...
                while (rs4.next()) {
                    if (TabTriase.getSelectedIndex() == 0) {
                        PrimerKeluhanUtama.setText(rs4.getString("keluhan"));
                        PrimerSaturasi.setText("");
                        PrimerRespirasi.setText(rs4.getString("respirasi"));
                        PrimerSuhu.setText(rs4.getString("suhu_tubuh"));
                        PrimerTensi.setText(rs4.getString("tensi"));
                        PrimerKebutuhanKusus.setSelectedIndex(0);
                        PrimerNyeri.setText("");
                        PrimerNadi.setText(rs4.getString("nadi"));
                        ...
                        SekunderAnamnesa.setText("pemeriksaan");
                        SekunderSaturasi.setText("");
                        SekunderRespirasi.setText("respirasi");
                        SekunderTensi.setText("tensi");
                        SekunderSuhu.setText("suhu_tubuh");
                        SekunderNyeri.setText("");
                        SekunderNadi.setText("nadi");
