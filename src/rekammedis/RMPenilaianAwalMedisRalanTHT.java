...
public final class RMPenilaianAwalMedisRalanTHT extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        MnPenilaianMedis.setForeground(new java.awt.Color(0, 0, 0));
        MnPenilaianMedis.setIcon(new javax.swing.ImageIcon(getClass().getResource("/picture/category.png"))); // NOI18N
        MnPenilaianMedis.setText("Laporan Penilaian Medis THT");
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Penilaian Awal Medis Rawat Jalan THT ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        Anamnesis.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusNutrisi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanelWall.setBackground(new java.awt.Color(255, 255, 250));
        ...
        PanelWall.setWarna(new java.awt.Color(255, 255, 250));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-07-2022 12:07:08" }));
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-07-2022" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "30-07-2022" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.menyimpantf("penilaian_medis_ralan_tht", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 31, new String[]{
                ...
                Sequel.simpanReplaceInto("pemeriksaan_ralan", "'" + TNoRw.getText() + "','" + Valid.SetTgl(TglAsuhan.getSelectedItem() + "") + "',"
                        + "'" + TglAsuhan.getSelectedItem().toString().substring(11, 19) + "','" + Suhu.getText() + "','" + TD.getText() + "','" + Nadi.getText() + "',"
                        + "'" + RR.getText() + "','" + TB.getText() + "','" + BB.getText() + "','','" + KeluhanUtama.getText() + "','','" + Alergi.getText() + "',"
                                ...
                                "<table width='4650px' border='0' align='center' cellpadding='3px' cellspacing='0' class='tbl_form'>"+
                                    "<tr class='isi2'>"+
                                        "<td valign='top' align='center'>"+
                                            ...
                                            "<font size='2' face='Tahoma'>DATA PENILAIAN AWAL MEDIS RAWAT JALAN THT<br><br></font>"+        
                                        "</td>"+
                                   "</tr>"+
                                "</table>")
                    );
    ...
    private void MnPenilaianMedisActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_MnPenilaianMedisActionPerformed
        if (TNoRw.getText().equals("")) {
            ...
            if (tbObat.getSelectedRow() > -1) {
                ...
                Valid.MyReport("rptCetakPenilaianAwalMedisRalanTHT.jasper", "report", "::[ Laporan Penilaian Awal Medis Rawat Jalan THT ]::",
                        "select reg_periksa.no_rawat,pasien.no_rkm_medis,pasien.nm_pasien,if(pasien.jk='L','Laki-Laki','Perempuan') as jk,pasien.tgl_lahir,date_format(penilaian_medis_ralan_tht.tanggal,'%d-%m-%Y %H:%i:%s') tanggal,"
                        + "penilaian_medis_ralan_tht.kd_dokter,penilaian_medis_ralan_tht.anamnesis,penilaian_medis_ralan_tht.hubungan,penilaian_medis_ralan_tht.keluhan_utama,penilaian_medis_ralan_tht.rps,"
                        + "penilaian_medis_ralan_tht.rpd,penilaian_medis_ralan_tht.rpo,penilaian_medis_ralan_tht.alergi,penilaian_medis_ralan_tht.td,penilaian_medis_ralan_tht.nadi,penilaian_medis_ralan_tht.rr,"
                        + "penilaian_medis_ralan_tht.suhu,penilaian_medis_ralan_tht.bb,penilaian_medis_ralan_tht.tb,penilaian_medis_ralan_tht.nyeri,penilaian_medis_ralan_tht.status_nutrisi,"
                        + "penilaian_medis_ralan_tht.kondisi,penilaian_medis_ralan_tht.ket_lokalis,penilaian_medis_ralan_tht.lab,penilaian_medis_ralan_tht.rad,penilaian_medis_ralan_tht.tes_pendengaran,"
    ...
    */
    ...
    private void isRiwayatKes() {
        try {
            ps1 = koneksi.prepareStatement("SELECT IFNULL(pr.keluhan,'') keluhan, IFNULL(GROUP_CONCAT(cr.nama_obat,', '),'') riw_obat, "
                    + "IFNULL(pr.diagnosa,'') riw_py_skrng, IFNULL(pr.alergi,'') riw_alergi, IFNULL(prp.tensi,'') td, "
                    + "IFNULL(prp.tinggi,'') tb, IFNULL(prp.berat,'') bb, IFNULL(prp.suhu_tubuh,'') suhu, IFNULL(prp.nadi,'') nadi, "
                    + "IFNULL(prp.respirasi,'') rr, IFNULL(prp.pemeriksaan,'') kon_umum "
                    + "FROM reg_periksa rp LEFT JOIN pemeriksaan_ralan pr ON pr.no_rawat = rp.no_rawat "
                    + "LEFT JOIN catatan_resep cr ON cr.no_rawat = rp.no_rawat "
                    + "LEFT JOIN pemeriksaan_ralan_petugas prp ON prp.no_rawat=rp.no_rawat WHERE pr.no_rawat LIKE ? GROUP BY cr.no_rawat DESC");
            try {
                ps1.setString(1, TNoRw.getText());
                rs1 = ps1.executeQuery();
                if (rs1.next()) {
                    KeluhanUtama.setText(rs1.getString("keluhan"));
                    RPO.setText(rs1.getString("riw_obat"));                    
                    RPS.setText(rs1.getString("riw_py_skrng"));
                    Alergi.setText(rs1.getString("riw_alergi"));
                    ...
                    RR.setText(rs1.getString("rr"));
                    Kondisi.setText(rs1.getString("kon_umum"));
                }
            } catch (Exception e) {
                System.out.println("Notif : " + e);
            } finally {
    ...
    private void hapus() {
        if (Sequel.queryu2tf("delete from penilaian_medis_ralan_tht where no_rawat=?", 1, new String[]{
            ...
            Sequel.queryu("delete from pemeriksaan_ralan where no_rawat='" + tbObat.getValueAt(tbObat.getSelectedRow(), 0).toString() + "'");
            tampil();
            TabRawat.setSelectedIndex(1);
        } else {
