...
public final class RMPenilaianAwalKeperawatanRalan extends javax.swing.JDialog {
    ...
    private int i = 0, jml = 0, index = 0, cek1 = 0;
    ...
    private void initComponents() {
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(0, 153, 255), 3), "::[ Penilaian Awal Keperawatan (Assesmen) Rawat Jalan ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        scrollInput.setPreferredSize(new java.awt.Dimension(102, 1140));

        FormInput.setBackground(new java.awt.Color(255, 255, 255));
        FormInput.setBorder(null);
        FormInput.setName("FormInput"); // NOI18N
        FormInput.setPreferredSize(new java.awt.Dimension(100, 1280));
        ...
        BMI.setForeground(new java.awt.Color(0, 0, 0));
        ...
        AlatBantu.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetBantu.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Prothesa.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetProthesa.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusPsiko.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetPsiko.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetTinggal.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetEdukasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel64.setBounds(735, 1060, 35, 23);
        ...
        Lapor.setForeground(new java.awt.Color(0, 0, 0));
        ...
        ATS.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BJM.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SG2.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetLapor.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SG1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        MSA.setForeground(new java.awt.Color(0, 0, 0));
        ...
        FormInput.add(Nyeri);
        Nyeri.setBounds(470, 820, 110, 23);
        ...
        jLabel79.setBounds(453, 1108, 120, 23);

        Provokes.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Provokes.setBounds(650, 820, 110, 23);

        KetProvokes.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetProvokes.setBounds(650, 850, 205, 23);
        ...
        Quality.setBounds(650, 880, 110, 23);

        KetQuality.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetQuality.setBounds(650, 910, 205, 23);

        jLabel81.setForeground(new java.awt.Color(0, 0, 0));
        jLabel81.setText("Kualitas : ");
        jLabel81.setName("jLabel81"); // NOI18N
        FormInput.add(jLabel81);
        jLabel81.setBounds(555, 880, 90, 23);
        ...
        jLabel82.setBounds(470, 925, 50, 23);
        ...
        Lokasi.setBounds(520, 940, 200, 23);

        jLabel83.setForeground(new java.awt.Color(0, 0, 0));
        jLabel83.setText("Lokasi :");
        jLabel83.setName("jLabel83"); // NOI18N
        FormInput.add(jLabel83);
        jLabel83.setBounds(470, 940, 45, 23);

        Menyebar.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Menyebar.setBounds(790, 940, 60, 23);
        ...
        jLabel84.setBounds(820, 970, 40, 23);

        SkalaNyeri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        SkalaNyeri.setBounds(586, 970, 60, 23);

        jLabel86.setForeground(new java.awt.Color(0, 0, 0));
        jLabel86.setText("Diberitahukan pada dokter ?");
        jLabel86.setName("jLabel86"); // NOI18N
        FormInput.add(jLabel86);
        jLabel86.setBounds(490, 1060, 150, 23);

        Durasi.setForeground(new java.awt.Color(0, 0, 0));
        ...
        Durasi.setBounds(745, 970, 67, 23);

        jLabel87.setForeground(new java.awt.Color(0, 0, 0));
        jLabel87.setText("Waktu / Durasi :");
        jLabel87.setName("jLabel87"); // NOI18N
        FormInput.add(jLabel87);
        jLabel87.setBounds(650, 970, 90, 23);

        jLabel88.setForeground(new java.awt.Color(0, 0, 0));
        jLabel88.setText("Severity : Skala Nyeri");
        ...
        NyeriHilang.setBounds(650, 1000, 130, 23);

        KetNyeri.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetNyeri.setBounds(650, 1030, 205, 23);

        jLabel89.setForeground(new java.awt.Color(0, 0, 0));
        jLabel89.setText("Nyeri hilang bila : ");
        jLabel89.setName("jLabel89"); // NOI18N
        FormInput.add(jLabel89);
        jLabel89.setBounds(555, 1000, 90, 23);

        PadaDokter.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PadaDokter.setBounds(650, 1060, 80, 23);

        KetDokter.setForeground(new java.awt.Color(0, 0, 0));
        ...
        scrollPane5.setBounds(453, 1130, 400, 143);
        ...
        TotalHasil.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TglAsuhan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-02-2020 15:24:26" }));
        ...
        GCS.setForeground(new java.awt.Color(0, 0, 0));
        ...
        CacatFisik.setForeground(new java.awt.Color(0, 0, 0));
        ...
        StatusBudaya.setForeground(new java.awt.Color(0, 0, 0));
        ...
        KetBudaya.setForeground(new java.awt.Color(0, 0, 0));
        ...
        PanelWall.setBounds(30, 820, 430, 250);
        ...
        jSeparator10.setBounds(0, 1100, 880, 1);
        ...
        Scroll6.setBounds(10, 1108, 400, 133);
        ...
        label12.setBounds(16, 1250, 60, 23);

        TCariMasalah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TCariMasalah.setBounds(80, 1250, 245, 23);

        BtnCariPemeriksaan1.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnCariPemeriksaan1.setBounds(330, 1250, 28, 23);

        BtnTambahMasalah.setForeground(new java.awt.Color(0, 0, 0));
        ...
        BtnTambahMasalah.setBounds(363, 1250, 28, 23);

        Bahasa.setEditable(false);
        Bahasa.setForeground(new java.awt.Color(0, 0, 0));
        ...
        jLabel76.setBounds(490, 420, 190, 23);
        ...
        jLabel90.setText("Ket. Penyebab :");
        jLabel90.setName("jLabel90"); // NOI18N
        FormInput.add(jLabel90);
        jLabel90.setBounds(555, 850, 90, 23);

        jLabel91.setForeground(new java.awt.Color(0, 0, 0));
        jLabel91.setText("Ket. Kualitas : ");
        jLabel91.setName("jLabel91"); // NOI18N
        FormInput.add(jLabel91);
        jLabel91.setBounds(555, 910, 90, 23);

        jLabel98.setForeground(new java.awt.Color(0, 0, 0));
        jLabel98.setText("Ket. Nyeri hilang : ");
        jLabel98.setName("jLabel98"); // NOI18N
        FormInput.add(jLabel98);
        jLabel98.setBounds(525, 1030, 120, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-02-2020" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "25-02-2020" }));
    ...
    private void BtnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpanActionPerformed
        if (TNoRM.getText().trim().equals("")) {
        ...
        } else if (CacatFisik.getText().trim().equals("")) {
            Valid.textKosong(CacatFisik, "cacat fisik");
        } else {
            if (Sequel.menyimpantf("penilaian_awal_keperawatan_ralan", "?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?", "No.Rawat", 58, new String[]{
                ...
                Durasi.getText(), NyeriHilang.getSelectedItem().toString(), KetNyeri.getText(), PadaDokter.getSelectedItem().toString(), KetDokter.getText(), Rencana.getText(), KdPetugas.getText(),CacatFisik.getText()
            }) == true) {
    ...
    private void BtnEditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEditActionPerformed
        if (TNoRM.getText().trim().equals("")) {
            ...
            if (Sequel.mengedittf("penilaian_awal_keperawatan_ralan", "no_rawat=?", "no_rawat=?,tanggal=?,informasi=?,td=?,nadi=?,rr=?,suhu=?,gcs=?,bb=?,tb=?,bmi=?,keluhan_utama=?,rpd=?,rpk=?,rpo=?,"
                    + "alergi=?,alat_bantu=?,ket_bantu=?,prothesa=?,ket_pro=?,adl=?,status_psiko=?,ket_psiko=?,hub_keluarga=?,tinggal_dengan=?,ket_tinggal=?,ekonomi=?,budaya=?,ket_budaya=?,"
                    + "edukasi=?,ket_edukasi=?,berjalan_a=?,berjalan_b=?,berjalan_c=?,hasil=?,lapor=?,ket_lapor=?,sg1=?,nilai1=?,sg2=?,nilai2=?,total_hasil=?,nyeri=?,provokes=?,ket_provokes=?,"
                    + "quality=?,ket_quality=?,lokasi=?,menyebar=?,skala_nyeri=?,durasi=?,nyeri_hilang=?,ket_nyeri=?,pada_dokter=?,ket_dokter=?,rencana=?,nip=?,nama_cacat_fisik=?", 59, new String[]{
                        ...
                        Suhu.getText(), GCS.getText(), BB.getText(), TB.getText(), BMI.getText(), KeluhanUtama.getText(), RPD.getText(), RPK.getText(), 
                        RPO.getText(), Alergi.getText(), AlatBantu.getSelectedItem().toString(), KetBantu.getText(),
                        Prothesa.getSelectedItem().toString(), KetProthesa.getText(), ADL.getSelectedItem().toString(), StatusPsiko.getSelectedItem().toString(), 
                        ...
                        KetBudaya.getText(), Edukasi.getSelectedItem().toString(),
                        KetEdukasi.getText(), ATS.getSelectedItem().toString(), BJM.getSelectedItem().toString(), MSA.getSelectedItem().toString(), 
                        ...
                        Provokes.getSelectedItem().toString(), KetProvokes.getText(), Quality.getSelectedItem().toString(), KetQuality.getText(), 
                        Lokasi.getText(), Menyebar.getSelectedItem().toString(), SkalaNyeri.getSelectedItem().toString(),
            ...
            try {
                if (TCari.getText().equals("")) {
                    ps = koneksi.prepareStatement(
                            "SELECT rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF (p.jk = 'L','Laki-Laki','Perempuan') AS jk, p.tgl_lahir, "
                            + "p.agama, bp.nama_bahasa, pa.nama_cacat_fisik nama_cacat, pa.tanggal, pa.informasi, pa.td, pa.nadi, pa.rr, pa.suhu, pa.bb, pa.tb, "
                            + "pa.nadi, pa.rr, pa.suhu, pa.gcs, pa.bb, pa.tb, pa.bmi, pa.keluhan_utama, pa.rpd, pa.rpk, pa.rpo, pa.alergi, pa.alat_bantu, "
                            + "pa.ket_bantu, pa.prothesa, pa.ket_pro, pa.adl, pa.status_psiko, pa.ket_psiko, pa.hub_keluarga, pa.tinggal_dengan, pa.ket_tinggal, "
                            + "pa.ekonomi, pa.edukasi, pa.ket_edukasi, pa.berjalan_a, pa.berjalan_b, pa.berjalan_c, pa.hasil, pa.lapor, pa.ket_lapor, "
                            + "pa.sg1, pa.nilai1, pa.sg2, pa.nilai2, pa.total_hasil, pa.nyeri, pa.provokes, pa.ket_provokes, pa.quality, "
                            + "pa.ket_quality, pa.lokasi, pa.menyebar, pa.skala_nyeri, pa.durasi, pa.nyeri_hilang, pa.ket_nyeri, pa.pada_dokter, "
                            + "pa.ket_dokter, pa.rencana, pa.nip, pt.nama, pa.budaya, pa.ket_budaya FROM reg_periksa rp  "
                            ...
                            + "WHERE pa.tanggal BETWEEN ? AND ? ORDER BY pa.tanggal");
                } else {
                    ps = koneksi.prepareStatement(
                            "SELECT rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF (p.jk = 'L','Laki-Laki','Perempuan') AS jk, p.tgl_lahir, "
                            + "p.agama, bp.nama_bahasa, pa.nama_cacat_fisik nama_cacat, pa.tanggal, pa.informasi, pa.td, pa.nadi, pa.rr, pa.suhu, pa.bb, "
                            + "pa.tb, pa.nadi, pa.rr, pa.suhu, pa.gcs, pa.bb, pa.tb, pa.bmi, pa.keluhan_utama, pa.rpd, pa.rpk, pa.rpo, "
                            + "pa.alergi, pa.alat_bantu, pa.ket_bantu, pa.prothesa, pa.ket_pro, pa.adl, pa.status_psiko, pa.ket_psiko, "
                            + "pa.hub_keluarga, pa.tinggal_dengan, pa.ket_tinggal, pa.ekonomi, pa.edukasi, pa.ket_edukasi, pa.berjalan_a, "
                            + "pa.berjalan_b, pa.berjalan_c, pa.hasil, pa.lapor, pa.ket_lapor, pa.sg1, pa.nilai1, pa.sg2, pa.nilai2, pa.total_hasil, "
                            + "pa.nyeri, pa.provokes, pa.ket_provokes, pa.quality, pa.ket_quality, pa.lokasi, pa.menyebar, pa.skala_nyeri, pa.durasi, "
                            + "pa.nyeri_hilang, pa.ket_nyeri, pa.pada_dokter, pa.ket_dokter, pa.rencana, pa.nip, pt.nama, pa.budaya, pa.ket_budaya "
                            + "FROM reg_periksa rp INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis "
                            + "INNER JOIN penilaian_awal_keperawatan_ralan pa ON rp.no_rawat = pa.no_rawat "
                            + "INNER JOIN petugas pt ON pa.nip = pt.nip INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien "
                            + "WHERE pa.tanggal BETWEEN ? AND ? AND rp.no_rawat LIKE ? OR  "
                            + "pa.tanggal BETWEEN ? AND ? AND p.no_rkm_medis LIKE ? OR  "
                            + "pa.tanggal BETWEEN ? AND ? AND p.nm_pasien LIKE ? OR  "
                            + "pa.tanggal BETWEEN ? AND ? AND pa.nip LIKE ? OR  "
                            + "pa.tanggal BETWEEN ? AND ? AND pt.nama LIKE ? ORDER BY pa.tanggal");
                }
...
//        Valid.pindah(evt,RPD,Alergi);
    ...
    private void BtnPrint1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrint1ActionPerformed
        if (tbPenilaian.getSelectedRow() > -1) {
            ...
            param.put("finger", Sequel.cariIsi("select sha1(sidikjari) from sidikjari inner join pegawai on pegawai.id=sidikjari.id where pegawai.nik=?", tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(), 63).toString()));
            try {
                masalahkeperawatan = "";
                ps2 = koneksi.prepareStatement(
                        "select master_masalah_keperawatan.kode_masalah,master_masalah_keperawatan.nama_masalah from master_masalah_keperawatan "
                        ...
                        + "where penilaian_awal_keperawatan_ralan_masalah.no_rawat=? order by kode_masalah");
                try {
                    ps2.setString(1, tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(), 0).toString());
                    rs2 = ps2.executeQuery();
                    while (rs2.next()) {
                        masalahkeperawatan = rs2.getString("nama_masalah") + ", " + masalahkeperawatan;
                    }
            ...
            Valid.MyReport("rptCetakPenilaianAwalKeperawatanRalan.jasper", "report", "::[ Laporan Penilaian Awal Keperawatan (Assesmen) Ralan ]::",
//            Valid.MyReportqry("rptCetakPenilaianAwalKeperawatanRalan.jasper", "report", "::[ Laporan Penilaian Awal Keperawatan (Assesmen) Ralan ]::",
                    "SELECT rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF (p.jk = 'L','Laki-Laki','Perempuan') AS jk, "
                    + "p.tgl_lahir, p.agama, bp.nama_bahasa, pa.nama_cacat_fisik nama_cacat, pa.tanggal, pa.informasi, pa.td, pa.nadi, "
                    + "pa.rr, pa.suhu, pa.bb, pa.tb, pa.nadi, pa.rr, pa.suhu, pa.gcs, pa.bb, pa.tb, pa.bmi, pa.keluhan_utama, "
                    + "pa.rpd, pa.rpk, pa.rpo, pa.alergi, pa.alat_bantu, pa.ket_bantu, pa.prothesa, pa.ket_pro, pa.adl, pa.status_psiko, "
                    + "pa.ket_psiko, pa.hub_keluarga, pa.tinggal_dengan, pa.ket_tinggal, pa.ekonomi, pa.edukasi, pa.ket_edukasi, "
                    + "pa.berjalan_a, pa.berjalan_b, pa.berjalan_c, pa.hasil, pa.lapor, pa.ket_lapor, pa.sg1, pa.nilai1, pa.sg2, "
                    + "pa.nilai2, pa.total_hasil, pa.nyeri, pa.provokes, pa.ket_provokes, pa.quality, pa.ket_quality, pa.lokasi, "
                    + "pa.menyebar, pa.skala_nyeri, pa.durasi, pa.nyeri_hilang, pa.ket_nyeri, pa.pada_dokter, pa.ket_dokter, "
                    + "pa.rencana, pa.nip, pt.nama, pa.budaya, pa.ket_budaya FROM reg_periksa rp  "
                    + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis INNER JOIN penilaian_awal_keperawatan_ralan pa ON rp.no_rawat = pa.no_rawat "
                    + "INNER JOIN petugas pt ON pa.nip = pt.nip INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien "
                    + "where rp.no_rawat='" + tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(), 0).toString() + "'", param);
        }
    ...
    */
        ...
        try {
            if (TCari.getText().equals("")) {
                ps = koneksi.prepareStatement(
                        ...
                        + "pa.ket_bantu, pa.prothesa, pa.ket_pro, pa.adl, pa.status_psiko, pa.ket_psiko, pa.hub_keluarga, pa.tinggal_dengan, pa.ket_tinggal, "
                        + "pa.ekonomi, pa.edukasi, pa.ket_edukasi, pa.berjalan_a, pa.berjalan_b, pa.berjalan_c, pa.hasil, pa.lapor, pa.ket_lapor, "
                        + "pa.sg1, pa.nilai1, pa.sg2, pa.nilai2, pa.total_hasil, pa.nyeri, pa.provokes, pa.ket_provokes, pa.quality, pa.ket_quality, "
                        + "pa.lokasi, pa.menyebar, pa.skala_nyeri, pa.durasi, pa.nyeri_hilang, pa.ket_nyeri, pa.pada_dokter, pa.ket_dokter, "
                        + "pa.rencana, pa.nip, pt.nama, pa.budaya, pa.ket_budaya FROM reg_periksa rp  "
                        + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis INNER JOIN penilaian_awal_keperawatan_ralan pa ON rp.no_rawat = pa.no_rawat "
                        + "INNER JOIN petugas pt ON pa.nip = pt.nip INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien where pa.tanggal between ? and ? order by pa.tanggal");
            } else {
                ps = koneksi.prepareStatement(
                        "SELECT rp.no_rawat, p.no_rkm_medis, p.nm_pasien, IF (p.jk = 'L','Laki-Laki','Perempuan') AS jk, p.tgl_lahir, "
                        + "p.agama, bp.nama_bahasa, pa.nama_cacat_fisik nama_cacat, pa.tanggal, pa.informasi, pa.td, pa.nadi, pa.rr, pa.suhu, pa.bb, "
                        + "pa.tb, pa.nadi, pa.rr, pa.suhu, pa.gcs, pa.bb, pa.tb, pa.bmi, pa.keluhan_utama, pa.rpd, pa.rpk, pa.rpo, pa.alergi, "
                        + "pa.alat_bantu, pa.ket_bantu, pa.prothesa, pa.ket_pro, pa.adl, pa.status_psiko, pa.ket_psiko, pa.hub_keluarga, pa.tinggal_dengan, "
                        + "pa.ket_tinggal, pa.ekonomi, pa.edukasi, pa.ket_edukasi, pa.berjalan_a, pa.berjalan_b, pa.berjalan_c, pa.hasil, pa.lapor, "
                        + "pa.ket_lapor, pa.sg1, pa.nilai1, pa.sg2, pa.nilai2, pa.total_hasil, pa.nyeri, pa.provokes, pa.ket_provokes, pa.quality, "
                        + "pa.ket_quality, pa.lokasi, pa.menyebar, pa.skala_nyeri, pa.durasi, pa.nyeri_hilang, pa.ket_nyeri, pa.pada_dokter, "
                        + "pa.ket_dokter, pa.rencana, pa.nip, pt.nama, pa.budaya, pa.ket_budaya FROM reg_periksa rp  "
                        + "INNER JOIN pasien p ON rp.no_rkm_medis = p.no_rkm_medis INNER JOIN penilaian_awal_keperawatan_ralan pa ON rp.no_rawat = pa.no_rawat "
                        + "INNER JOIN petugas pt ON pa.nip = pt.nip INNER JOIN bahasa_pasien bp ON bp.id = p.bahasa_pasien "
    ...
    private void getData() {
        if(tbPenilaian.getSelectedRow()!= -1){
            ...
            Agama.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),4).toString());
            Bahasa.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),5).toString());
            CacatFisik.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),6).toString());
            TglLahir.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),7).toString()); 
            Informasi.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),9).toString());
            TD.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),10).toString());
            Nadi.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),11).toString());
            RR.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),12).toString());
            Suhu.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),13).toString());
            GCS.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),14).toString());
            BB.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),15).toString());
            TB.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),16).toString());
            BMI.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),17).toString());
            KeluhanUtama.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),18).toString());
            RPD.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),19).toString());
            RPK.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),20).toString());
            RPO.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),21).toString());
            Alergi.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),22).toString());
            AlatBantu.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),23).toString());
            KetBantu.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),24).toString());
            Prothesa.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),25).toString());
            KetProthesa.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),26).toString());
            ADL.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),27).toString());
            StatusPsiko.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),28).toString());
            KetPsiko.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),29).toString());
            HubunganKeluarga.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),30).toString());
            TinggalDengan.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),31).toString());
            KetTinggal.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),32).toString());
            Ekonomi.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),33).toString());
            StatusBudaya.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),34).toString());
            KetBudaya.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),35).toString());
            Edukasi.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),36).toString());
            KetEdukasi.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),37).toString());
            ATS.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),38).toString());
            BJM.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),39).toString());
            MSA.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),40).toString());
            Hasil.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),41).toString());
            Lapor.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),42).toString());
            KetLapor.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),43).toString());
            SG1.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),44).toString());
            Nilai1.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),45).toString());
            SG2.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),46).toString());
            Nilai2.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),47).toString());
            TotalHasil.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),48).toString());
            Nyeri.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),49).toString());
            Provokes.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),50).toString());
            KetProvokes.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),51).toString());
            Quality.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),52).toString());
            KetQuality.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),53).toString());
            Lokasi.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),54).toString());
            Menyebar.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),55).toString());
            SkalaNyeri.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),56).toString());
            Durasi.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),57).toString());
            NyeriHilang.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),58).toString());
            KetNyeri.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),59).toString());
            PadaDokter.setSelectedItem(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),60).toString());
            KetDokter.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),61).toString());
            Rencana.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),62).toString());
            KdPetugas.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),63).toString());
            NmPetugas.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),64).toString());
            Valid.SetTgl2(TglAsuhan,tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),8).toString());
            ...
            try {
                ...
                ps=koneksi.prepareStatement(
                        ...
                        "where penilaian_awal_keperawatan_ralan_masalah.no_rawat=? order by kode_masalah");
                try {
                    ps.setString(1,tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(),0).toString());
                    rs=ps.executeQuery();
                    while(rs.next()){
    ...
    private void isRawat() {
        ...
        try {
            ps = koneksi.prepareStatement(
                    "select p.nm_pasien, if(p.jk='L','Laki-Laki','Perempuan') jk, p.tgl_lahir,p.agama,bp.nama_bahasa,'-' nama_cacat "
                    + "from pasien p inner join bahasa_pasien bp on bp.id=p.bahasa_pasien "
    ...
    private void cekDataPerawat() {
        cek1 = 0;
        cek1 = Sequel.cariInteger("select count(1) cek from pemeriksaan_ralan_petugas where no_rawat='" + TNoRw.getText() + "'");
        ...
        if (cek1 == 0) {
            ...
            try {
                ps3 = koneksi.prepareStatement("select tgl_perawatan, jam_rawat, suhu_tubuh, tensi, nadi, respirasi, tinggi, berat, "
                        + "gcs, keluhan, pemeriksaan, alergi, imun_ke, diagnosa, rencana_follow_up, "
                        + "rincian_tindakan from pemeriksaan_ralan_petugas where no_rawat='" + TNoRw.getText() + "'");
                try {
                    rs3 = ps3.executeQuery();
                    while (rs3.next()) {
                        TD.setText(rs3.getString("tensi"));
                        Nadi.setText(rs3.getString("nadi"));
                        RR.setText(rs3.getString("respirasi"));
                        Suhu.setText(rs3.getString("suhu_tubuh"));
                        GCS.setText(rs3.getString("gcs"));
                        BB.setText(rs3.getString("berat"));                        
                        TB.setText(rs3.getString("tinggi"));
                        KeluhanUtama.setText(rs3.getString("keluhan"));
                        Alergi.setText(rs3.getString("alergi"));
                        Rencana.setText(rs3.getString("rencana_follow_up"));
                    }
                } catch (Exception e) {
                    System.out.println("Notifikasi : " + e);
                } finally {
    ...
    private void getMasalah() {
        if (tbPenilaian.getSelectedRow() != -1) {
            ...
            DetailRencana.setText(tbPenilaian.getValueAt(tbPenilaian.getSelectedRow(), 62).toString());
            try {
                Valid.tabelKosong(tabModeDetailMasalah);
                ps = koneksi.prepareStatement(
                        "select master_masalah_keperawatan.kode_masalah,master_masalah_keperawatan.nama_masalah from master_masalah_keperawatan "
