...
public class DlgBilingRanap extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        DTPTgl.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-09-2021 10:46:05" }));
...
//    if (TPasien.getText().trim().equals("")) {
    JOptionPane.showMessageDialog(null, "Silakan input tindakan di menu kamar inap...!!!");
//        TNoRw.requestFocus();
//    } else {
