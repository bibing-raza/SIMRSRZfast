...
public final class DlgPemasukanLain extends javax.swing.JDialog {
    ...
    public DlgPemasukanLain(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row = {"No. Transaksi", "Tanggal", "Jam", "Jenis Pemasukan Lain",
            ...
            "Sudah dibayar","Sisa Tagihan","Jumlh. Dibayar","Sisa Stlah Bayar"
        };
...
//              column.setPreferredWidth(90);
    ...
    private void initComponents() {
        ...
        nmpasien.setBounds(366, 25, 340, 23);
        ...
        DTPCari1.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-09-2021" }));
        ...
        DTPCari2.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-09-2021" }));
        ...
        PanelInput.setPreferredSize(new java.awt.Dimension(440, 205));
        ...
        Tanggal.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "09-09-2021" }));
        ...
        jLabel11.setBounds(443, 70, 160, 23);
        ...
        pemasukan.setBounds(537, 40, 139, 23);
        ...
        jLabel15.setBounds(443, 40, 90, 23);
        ...
        telahTerimaPAS.setBounds(608, 70, 315, 23);
        ...
        Scroll3.setBounds(85, 100, 360, 75);
        ...
        labelSewa.setBounds(680, 40, 104, 23);
        ...
        nominalSewa.setBounds(785, 40, 139, 23);

        jLabel16.setForeground(new java.awt.Color(0, 0, 0));
        jLabel16.setText("Telah terima (Atas Nama Lain) :");
        jLabel16.setName("jLabel16"); // NOI18N
        FormInput.add(jLabel16);
        jLabel16.setBounds(443, 100, 160, 23);
        ...
        telahTerimaAN.setBounds(608, 100, 315, 23);
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
    ...
    private void BtnSimpan6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan6ActionPerformed
        ...
        if (KdPtg.getText().trim().equals("") || NmPtg.getText().trim().equals("")) {
            ...
            Valid.textKosong(telahTerimaPAS, "Tgl. Masuk");
            tglmsk.requestFocus();
        } else if (tglklr.getText().trim().equals("")) {
            Valid.textKosong(telahTerimaPAS, "Tgl. Keluar/Pulang");
            NoSEP.requestFocus();
        } else if ((kdINACBG.getText().trim().equals("")) && (deskripsiKD.getText().trim().equals(""))) {
            Valid.textKosong(telahTerimaPAS, "Kode & deskripsi INACBG");
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if (kdINACBG.getText().equals("")) {
            ...
            Valid.MyReport("rptTarifINACBG.jasper", "report", "::[ Lampiran Kwitansi (Tarif INACBG) ]::",
                    " SELECT t.INACBG, k.DESKRIPSI, t.KELAS_RAWAT, convert((t.TARIFF ),int) tarifnya FROM kode_inacbg k "
                    + " INNER JOIN tarif_eklaim t on t.INACBG=k.INACBG "
                    + " WHERE t.REGIONAL='reg4' AND t.KODE_TARIFF='bp' AND t.JENIS_PELAYANAN='1' "
...
//            }
    ...
    private void getData() {
        ...
        if (tbPemasukan.getSelectedRow() != -1) {
            ...
            pemasukan.setText(tbPemasukan.getValueAt(tbPemasukan.getSelectedRow(), 5).toString());            
            ...
            if (KdKategori.getText().equals("SBPJS") && (!dataSelisihTarif.getText().equals(""))) {
                ...
                if (statusTran.getText().equals("dicicil")) {
                    ...
                    Keterangan.setText("Jumlah pembayaran utk. pelunasan tagihan dgn. kalkulasi penghitungan "+ rumusbayar.getText()
...
//            hasilLM.setText("");
//            Sequel.cariIsi("SELECT k.kelas FROM kamar_inap ki INNER JOIN kamar k on k.kd_kamar=ki.kd_kamar "
//                    + "INNER JOIN bangsal b on b.kd_bangsal=k.kd_bangsal WHERE ki.kd_kamar not like '%IC%' and ki.no_rawat=? order by tgl_keluar desc limit 1 ", naikKLS, norawat.getText());
//
//            Sequel.cariIsi("SELECT ki.lama FROM reg_periksa r INNER JOIN kamar_inap ki on ki.no_rawat=r.no_rawat INNER JOIN kamar k on k.kd_kamar=ki.kd_kamar "
//                    + "INNER JOIN bangsal b on b.kd_bangsal=k.kd_bangsal LEFT JOIN bridging_sep bs on bs.no_rawat=ki.no_rawat "
...
//        }
        ...
        Sequel.cariIsi("SELECT b.nm_bangsal FROM kamar_inap ki INNER JOIN kamar k on k.kd_kamar=ki.kd_kamar "
                + "INNER JOIN bangsal b on b.kd_bangsal=k.kd_bangsal WHERE stts_pulang not in ('-','Pindah Kamar') and no_rawat=? ", rginap, norawat.getText());
    ...
    private void SimpanNotaNaikKelas() {
        try {
            ...
            psTem1 = koneksi.prepareStatement("SELECT CONCAT(p.nm_pasien,' (No.RM : ', pl.no_rkm_medis,')') pasien, pl.no_kartu, CONCAT('1704R0', pl.no_sep) nosep, "
                    ...
                    + "pl.kode_inacbg, ki.DESKRIPSI, pl.no_transaksi, pl.rumus_selisih_tarif, format(pl.besar,0) besar, pt.nama petugas "
                    + "FROM pemasukan_lain pl INNER JOIN petugas pt ON pt.nip = pl.nip INNER JOIN pasien p ON p.no_rkm_medis = pl.no_rkm_medis "
                    + "INNER JOIN kode_inacbg ki ON ki.INACBG = pl.kode_inacbg WHERE pl.no_transaksi = '" + noTransaksi.getText() + "'");
            try {
                ...
                while (rsTem1.next()) {
                    Sequel.menyimpan("temporary_bayar_ranap",
                            ...
                            + rsTem1.getString("DESKRIPSI") + "','"
                            + rsTem1.getString("no_transaksi") + "','"
                            + rsTem1.getString("rumus_selisih_tarif") + "','"
