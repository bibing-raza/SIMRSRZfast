...
public class DlgUser extends javax.swing.JDialog {
    ...
    public DlgUser(java.awt.Frame parent, boolean modal) {
        ...
        tabMode1 = new DefaultTableModel(null, new Object[]{"KD Baris", "NIP/Kode User", "Nama User", 
            "Kode Unit", "Nama Unit/Poli/Ruang", "Jns. Unit"}) {
            @Override
            public boolean isCellEditable(int rowIndex, int colIndex) {
                return false;
            }
    ...
    private void initComponents() {
        ...
        kodeBaris.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                kodeBarisKeyPressed(evt);
            }
        });
        ...
        MnSetUser.setForeground(new java.awt.Color(0, 0, 0));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Setup User ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        jLabel4.setBounds(635, 10, 60, 23);
        ...
        BtnSeek.setBounds(300, 10, 28, 23);
        ...
        BtnSeek1.setBounds(330, 10, 28, 23);
        ...
        TNmUser.setBounds(360, 10, 270, 23);
        ...
        BtnKeluar.setBounds(890, 10, 80, 30);
        ...
        NmRuangan.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "- pilih salah satu -", "ZAAL", "RKPD", "PARU", "JANTUNG", "AS-SAMI", "ANAK", "BEDAH", "INTERNIST", "ICU/ICCU", "NICU", "OBGYN", "VIP", "SVIP", "BAYI-SEHAT", "AR-RAUDAH", "SYARAF", "MATA-THT-KK", "ISOLASI COVID19", "ISOLASI BAYI COVID19", "COVID19", "SEMUA RUANG" }));
        NmRuangan.setName("NmRuangan"); // NOI18N
        NmRuangan.setPreferredSize(new java.awt.Dimension(130, 20));
...
private void BtnPrintKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnPrintKeyPressed
    ...
    private void BtnSimpan1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnSimpan1ActionPerformed
        ...
        if (TKd.getText().trim().equals("") || TNmUser.getText().trim().equals("")) {
            Valid.textKosong(TKd, "User");
                ...
                && (NmRuangan.getSelectedItem().equals("- pilih salah satu -"))) {
            JOptionPane.showMessageDialog(null, "Silakan pilih salah satu nama ruangannya dulu...!!!!");
            NmRuangan.requestFocus();
        } else if (TKd.getText().equals("PPRM") || (TKd.getText().equals("PR13"))) {
            JOptionPane.showMessageDialog(null, "" + TNmUser.getText() + " sudah memiliki hak akses penuh, data tidak bisa disimpan...!!!");
            BtnCari1.requestFocus();
        } else if (noID.getText().equals("")) {
            JOptionPane.showMessageDialog(null, "Karyawan tersebut belum masuk ke data petugas, tambahkan dulu ke data petugas...!!!!");
        } else {
            if (cekUnit.isSelected() == true) {
                if (kdpoli.getText().equals("")) {
                    Sequel.menyimpan("hak_akses_unit", "'" + TKd.getText() + "',NULL,'0' ", "Hak akses unit");
                } else if (!kdpoli.getText().equals("")) {
                    Sequel.menyimpan("hak_akses_unit", "'" + TKd.getText() + "','" + kdpoli.getText() + "','0' ", "Hak akses unit");
                }
            } else if (cekUnit.isSelected() == false) {
                if (NmRuangan.getSelectedItem().equals("SEMUA RUANG")) {
                    Sequel.menyimpan("hak_akses_unit", "'" + TKd.getText() + "',NULL,'0' ", "Hak akses unit");
                } else if (!NmRuangan.getSelectedItem().equals("SEMUA RUANG")) {
                    Sequel.menyimpan("hak_akses_unit", "'" + TKd.getText() + "','" + NmRuangan.getSelectedItem().toString() + "','0' ", "Hak akses unit");
                }
            }
            tampil1();
            emptTeks();
    ...
    private void BtnHapus1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnHapus1ActionPerformed
        if (tabMode1.getRowCount() == 0) {
            ...
            JOptionPane.showMessageDialog(null, "" + TNmUser.getText() + " sudah memiliki hak akses penuh, data tidak bisa dihapus...!!!");
            BtnCari1.requestFocus();
    ...
    private void BtnHapus1KeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_BtnHapus1KeyPressed
        if(evt.getKeyCode()==KeyEvent.VK_PAGE_DOWN){
            ...
            Valid.pindah(evt, BtnSimpan1, BtnEdit1);
        }
    ...
    private void BtnEdit1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnEdit1ActionPerformed
        if (TKd.getText().trim().equals("") || TNmUser.getText().trim().equals("")) {
            ...
            JOptionPane.showMessageDialog(null, "" + TNmUser.getText() + " sudah memiliki hak akses penuh, perubahan tidak bisa dilakukan...!!!!");
            BtnCari1.requestFocus();
        } else {
            if (cekUnit.isSelected() == true) {
                if (kdpoli.getText().equals("")) {
                    Sequel.mengedit("hak_akses_unit", "kd_baris='" + kodeBaris.getText() + "'", "nip='" + TKd.getText() + "', kode_unit=NULL ");
                } else if (!kdpoli.getText().equals("")) {
                    Sequel.mengedit("hak_akses_unit", "kd_baris='" + kodeBaris.getText() + "'", "nip='" + TKd.getText() + "', kode_unit='" + kdpoli.getText() + "' ");
                }
            } else if (cekUnit.isSelected() == false) {
                if (NmRuangan.getSelectedItem().equals("SEMUA RUANG")) {
                    Sequel.mengedit("hak_akses_unit", "kd_baris='" + kodeBaris.getText() + "'", "nip='" + TKd.getText() + "', kode_unit=NULL ");
                } else if (!NmRuangan.getSelectedItem().equals("SEMUA RUANG")) {
                    Sequel.mengedit("hak_akses_unit", "kd_baris='" + kodeBaris.getText() + "'", "nip='" + TKd.getText() + "', kode_unit='" + NmRuangan.getSelectedItem().toString() + "' ");
                }
            }
            tampil1();
            emptTeks();
    ...
    private void kodeBarisKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_kodeBarisKeyPressed
        // TODO add your handling code here:
    }//GEN-LAST:event_kodeBarisKeyPressed
    ...
    */
    ...
    private void tampil1() { 
        ...
        cari6 = "(IFNULL(h.kode_unit,'Khusus')) like '%" + TCari1.getText() + "%'";
        cari7 = "(IF(h.kode_unit=pl.kd_poli,'Rawat Jalan','Rawat Inap')) like '%" + TCari1.getText() + "%'";
        cari8 = "(IF(h.nip='PPRM','SEMUANYA', IF(pl.nm_poli IS NULL,CONCAT('Ruang Inap ',IFNULL(h.kode_unit,'Menyesuaikan..!!!')),pl.nm_poli))) like '%" + TCari1.getText() + "%'";
                        
        Valid.tabelKosong(tabMode1);
        try {
            if (TCari1.getText().equals("")) {
                ps1 = koneksi.prepareStatement(" SELECT h.kd_baris, h.nip, p.nama, IFNULL(h.kode_unit,'Khusus') kode_unit, "
                        + " IF((h.nip='PPRM' or h.nip='PR13'),'SEMUANYA', IF(pl.nm_poli IS NULL,CONCAT('Ruang Inap ',IFNULL(h.kode_unit,'Menyesuaikan..!!!')),pl.nm_poli)) unit, "
                        + " IF(h.kode_unit=pl.kd_poli,'Rawat Jalan','Rawat Inap') jns_unit "
