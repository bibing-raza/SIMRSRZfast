...
public final class DlgPetugas extends javax.swing.JDialog {
    ...
    public DlgPetugas(java.awt.Frame parent, boolean modal) {
        ...
        Object[] row={"NIP","Nama Petugas","J.K.","Tmp.Lahir","Tgl.Lahir","G.D.","Agama","Stts.Nikah","Alamat","Jabatan","No.Telp","NIK/No. KTP"};
    ...
    private void initComponents() {
        ...
        MnRestore.setPreferredSize(new java.awt.Dimension(130, 28));
        ...
        internalFrame1.setBorder(javax.swing.BorderFactory.createTitledBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(240, 245, 235)), "::[ Data Petugas ]::", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Tahoma", 1, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        DTPLahir.setForeground(new java.awt.Color(0, 0, 0));
        DTPLahir.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "07-05-2019" }));
        ...
        KdJbtn.setEditable(false);
        KdJbtn.setForeground(new java.awt.Color(0, 0, 0));
        ...
        TnoKTP.setBounds(730, 72, 150, 23);
    ...
    private void BtnPrintActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_BtnPrintActionPerformed
        if(tabMode.getRowCount()==0){
            ...
            BtnBatal.requestFocus();
                ...
                Valid.MyReport("rptPetugas.jasper","report","::[ Data Petugas ]::","select petugas.nip,petugas.nama,petugas.jk,petugas.tmp_lahir,petugas.tgl_lahir, "+
...
private void ChkInputActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_ChkInputActionPerformed
  isForm();                
    ...
    private void TnoKTPKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_TnoKTPKeyPressed
        Valid.pindah(evt,TnoKTP,btnJabatan);
    ...
    */
    ...
    private void tampil() {
        ...
        try{
            ps=koneksi.prepareStatement(
                    "SELECT petugas.nip, petugas.nama, petugas.jk, petugas.tmp_lahir, petugas.tgl_lahir, petugas.gol_darah, petugas.agama, "
                    + "petugas.stts_nikah, petugas.alamat, jabatan.nm_jbtn, petugas.no_telp, IF(pegawai.no_ktp='','-',pegawai.no_ktp) no_ktp "
                    + "FROM petugas INNER JOIN jabatan ON jabatan.kd_jbtn = petugas.kd_jbtn INNER JOIN pegawai ON pegawai.nik = petugas.nip "
                    ...
                    + " petugas.status='1' and petugas.jk like ? and petugas.gol_darah like ? and petugas.stts_nikah like ? and pegawai.no_ktp like ? or "
            ...
            try {
                ...
                ps.setString(41,"%"+cmbCrJk.getSelectedItem().toString().replaceAll("LAKI-LAKI","L").replaceAll("PEREMPUAN","P").trim()+"%");
                ps.setString(42,"%"+CmbCrGd.getSelectedItem().toString().trim()+"%");
                ps.setString(43,"%"+CmbCrStts.getSelectedItem().toString().trim()+"%");
    ...
    private void getData() {
        ...
        if(row!= -1){
            ...
            TnoKTP.setText(tbPetugas.getValueAt(row,11).toString());
